...
**initiator** | [**\Tzkt\Model\TransactionOperationAllOfInitiator**](TransactionOperationAllOfInitiator.md) |  | [optional]
**sender** | [**\Tzkt\Model\TransactionOperationAllOfSender**](TransactionOperationAllOfSender.md) |  | [optional]
...
**target** | [**\Tzkt\Model\TransactionOperationAllOfTarget**](TransactionOperationAllOfTarget.md) |  | [optional]
...
**diffs** | [**\Tzkt\Model\BigMapDiff[]**](BigMapDiff.md) | List of bigmap updates (aka big_map_diffs) caused by the transaction. | [optional]
...
**quote** | [**\Tzkt\Model\TransactionOperationAllOfQuote**](TransactionOperationAllOfQuote.md) |  | [optional]
