...
------------ | ------------- | ------------- | -------------
**type** | **string** | Type of the operation, &#x60;attestation_reward&#x60; | [optional]
...
**baker** | [**\Tzkt\Model\AttestationRewardOperationAllOfBaker**](AttestationRewardOperationAllOfBaker.md) |  | [optional]
**expected** | **int** | Expected attestation reward, based on baker&#39;s active stake (micro tez) | [optional]
...
**quote** | [**\Tzkt\Model\AttestationRewardOperationAllOfQuote**](AttestationRewardOperationAllOfQuote.md) |  | [optional]
