...
**address** | **string** | Public key hash of the delegate&#39;s main key | [optional]
**consensus_address** | **string** | Public key hash of the delegate&#39;s consensus key | [optional]
**companion_address** | **string** | Public key hash of the delegate&#39;s companion key | [optional]
...
**unstaked_baker** | [**\Tzkt\Model\DelegateAllOfUnstakedBaker**](DelegateAllOfUnstakedBaker.md) |  | [optional]
...
**baking_power** | **int** | Current baking power | [optional]
**voting_power** | **int** | Current voting power | [optional]
**own_delegated_balance** | **int** | Amount delegated from the own balance (micro tez). | [optional]
**external_delegated_balance** | **int** | Amount delegated from the external delegators (micro tez). | [optional]
...
**num_attestations** | **int** | Number of given attestations (approvals) by the delegate (baker) | [optional]
**num_preattestations** | **int** | Number of given preattestations (approvals) by the delegate (baker) | [optional]
...
**num_double_consensus** | **int** | Number of double consensus (attestation or preattestation of two different blocks at the same block height) evidence operations, included in blocks, baked (validated) by the delegate | [optional]
...
**num_attestation_rewards** | **int** | Number of attestation rewards received at the end of cycles (synthetic type) | [optional]
...
**update_secondary_key_count** | **int** | Number of &#x60;update_secondary_key&#x60; operations sent by the account | [optional]
...
**software_update_level** | **int** | Level of the first block baked by the baker with the current software version | [optional]
**software_update_time** | **\DateTime** | Datetime of the first block baked by the baker with the current software version | [optional]
**staking_balance** | **int** | **DEPRECATED** | [optional]
**delegated_balance** | **int** | **DEPRECATED** | [optional]
**update_consensus_key_count** | **int** | **DEPRECATED** | [optional]
**num_endorsements** | **int** | **DEPRECATED** | [optional]
**num_preendorsements** | **int** | **DEPRECATED** | [optional]
**num_double_endorsing** | **int** | **DEPRECATED** | [optional]
**num_double_preendorsing** | **int** | **DEPRECATED** | [optional]
**num_endorsing_rewards** | **int** | **DEPRECATED** | [optional]
