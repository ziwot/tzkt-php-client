...
**accuser** | [**\Tzkt\Model\DoubleBakingOperationAllOfAccuser**](DoubleBakingOperationAllOfAccuser.md) |  | [optional]
**reward** | **int** | Reward of the baker, produced the block, in which the accusation was included | [optional]
**offender** | [**\Tzkt\Model\DoubleBakingOperationAllOfOffender**](DoubleBakingOperationAllOfOffender.md) |  | [optional]
