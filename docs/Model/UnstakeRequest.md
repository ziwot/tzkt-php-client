...
**staker** | [**\Tzkt\Model\UnstakeRequestStaker**](UnstakeRequestStaker.md) |  | [optional]
...
**unlock_cycle** | **int** | Cycle at which the unstake request will become finalizable | [optional]
**unlock_level** | **int** | Level of the block at which the unstake request will become finalizable | [optional]
**unlock_time** | **\DateTime** | Timestamp of the block at which the unstake request will become finalizable | [optional]
