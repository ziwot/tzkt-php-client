...
**attesters_per_block** | **int** | Number of bakers that assigned to attest a block | [optional]
...
**attestation_deposit** | **int** | Security deposit for sending an attestation operation (micro tez) | [optional]
**attestation_reward** | **int[]** | Reward for sending an attestation operation (micro tez) | [optional]
...
**consensus_threshold** | **int** | Attestation quorum | [optional]
**min_participation_numerator** | **int** | Number of attested slots needed to receive attestation rewards | [optional]
**min_participation_denominator** | **int** | Number of attested slots needed to receive attestation rewards | [optional]
**denunciation_period** | **int** | Number of cycles after double baking/(pre)attestation where an accusation operation can be injected | [optional]
...
**endorsers_per_block** | **int** | **DEPRECATED** | [optional]
**endorsement_deposit** | **int** | **DEPRECATED** | [optional]
**endorsement_reward** | **int[]** | **DEPRECATED** | [optional]
