...
**attestation_power** | **int** | Recorder attestation power | [optional]
**attestation_committee** | **int** | Total attestation committee power | [optional]
...
**proposer** | [**\Tzkt\Model\BlockProposer**](BlockProposer.md) |  | [optional]
**producer** | [**\Tzkt\Model\BlockProducer**](BlockProducer.md) |  | [optional]
**software** | [**\Tzkt\Model\BlockSoftware**](BlockSoftware.md) |  | [optional]
...
**attestations** | [**\Tzkt\Model\AttestationOperation[]**](AttestationOperation.md) | List of attestation (is operation, which specifies the head of the chain as seen by the attester of a given slot) operations, included in the block | [optional]
**preattestations** | [**\Tzkt\Model\PreattestationOperation[]**](PreattestationOperation.md) | List of preattestation operations, included in the block | [optional]
...
**double_consensus** | [**\Tzkt\Model\DoubleConsensusOperation[]**](DoubleConsensusOperation.md) | List of double consensus evidence (is used by bakers to provide evidence of double (pre)attestation ((pre)attestation of two different blocks at the same block height) by a baker) operations, included in the block | [optional]
...
**increase_paid_storage_ops** | [**\Tzkt\Model\IncreasePaidStorageOperation[]**](IncreasePaidStorageOperation.md) | List of increase paid storage operations, included in the block | [optional]
**update_secondary_key_ops** | [**\Tzkt\Model\UpdateSecondaryKeyOperation[]**](UpdateSecondaryKeyOperation.md) | List of update secondary key operations, included in the block | [optional]
...
**attestation_rewards** | [**\Tzkt\Model\AttestationRewardOperation[]**](AttestationRewardOperation.md) | List of attestation rewards, implicitly applied at the end of the block | [optional]
...
**validations** | **int** | **DEPRECATED** | [optional]
**ai_toggle** | **bool** | **DEPRECATED** | [optional]
**ai_toggle_ema** | **int** | **DEPRECATED** | [optional]
**update_consensus_key_ops** | [**\Tzkt\Model\UpdateSecondaryKeyOperation[]**](UpdateSecondaryKeyOperation.md) | **DEPRECATED** | [optional]
**endorsements** | [**\Tzkt\Model\AttestationOperation[]**](AttestationOperation.md) | **DEPRECATED** | [optional]
**preendorsements** | [**\Tzkt\Model\PreattestationOperation[]**](PreattestationOperation.md) | **DEPRECATED** | [optional]
**double_endorsing** | [**\Tzkt\Model\DoubleConsensusOperation[]**](DoubleConsensusOperation.md) | **DEPRECATED** | [optional]
**double_preendorsing** | [**\Tzkt\Model\DoubleConsensusOperation[]**](DoubleConsensusOperation.md) | **DEPRECATED** | [optional]
**endorsing_rewards** | [**\Tzkt\Model\AttestationRewardOperation[]**](AttestationRewardOperation.md) | **DEPRECATED** | [optional]
