...
class BlocksApi
{
     ...
     * @param  \Tzkt\Model\BlocksGetTimestampParameter|null $timestamp Filters blocks by timestamp. (optional)
     ...
     * @param  \Tzkt\Model\AccountsGetSortParameter|null $sort Sorts blocks by specified field. Supported fields: &#x60;id&#x60; (default), &#x60;level&#x60;, &#x60;payloadRound&#x60;, &#x60;blockRound&#x60;, &#x60;attestationPower&#x60;, &#x60;reward&#x60;, &#x60;bonus&#x60;, &#x60;fees&#x60;. (optional)
    ...
    {
        list($response) = $this->blocksGetWithHttpInfo($anyof, $proposer, $producer, $level, $timestamp, $block_round, $select, $sort, $offset, $limit, $quote, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->blocksGetRequest($anyof, $proposer, $producer, $level, $timestamp, $block_round, $select, $sort, $offset, $limit, $quote, $contentType);
    ...
    {
        return $this->blocksGetAsyncWithHttpInfo($anyof, $proposer, $producer, $level, $timestamp, $block_round, $select, $sort, $offset, $limit, $quote, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
