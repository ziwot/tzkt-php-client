...
class StakingApi
{
     ...
     * @param  \Tzkt\Model\AccountsGetActivityTimestampParameter|null $timestamp Filter by timestamp of the block, where the staking update happened.   Click on the parameter to expand more details. (optional)
     ...
     * @param  \Tzkt\Model\StakingGetStakingUpdatesCountRoundingErrorParameter|null $double_consensus_op_id Filter by the ID of the related operation.   Click on the parameter to expand more details. (optional)
    ...
    public function stakingGetStakingUpdates(
        ...
        ?\Tzkt\Model\StakingGetStakingUpdatesCountRoundingErrorParameter $double_consensus_op_id = null,
    ...
    {
        list($response) = $this->stakingGetStakingUpdatesWithHttpInfo($id, $level, $timestamp, $cycle, $baker, $staker, $type, $amount, $pseudotokens, $rounding_error, $autostaking_op_id, $staking_op_id, $delegation_op_id, $double_baking_op_id, $double_consensus_op_id, $sort, $offset, $limit, $select, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->stakingGetStakingUpdatesRequest($id, $level, $timestamp, $cycle, $baker, $staker, $type, $amount, $pseudotokens, $rounding_error, $autostaking_op_id, $staking_op_id, $delegation_op_id, $double_baking_op_id, $double_consensus_op_id, $sort, $offset, $limit, $select, $contentType);
    ...
    {
        return $this->stakingGetStakingUpdatesAsyncWithHttpInfo($id, $level, $timestamp, $cycle, $baker, $staker, $type, $amount, $pseudotokens, $rounding_error, $autostaking_op_id, $staking_op_id, $delegation_op_id, $double_baking_op_id, $double_consensus_op_id, $sort, $offset, $limit, $select, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $double_consensus_op_id,
            'doubleConsensusOpId', // param base name
            '\Tzkt\Model\Int64NullParameter', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    {
        list($response) = $this->stakingGetStakingUpdatesCountWithHttpInfo($id, $level, $timestamp, $cycle, $baker, $staker, $type, $amount, $pseudotokens, $rounding_error, $autostaking_op_id, $staking_op_id, $delegation_op_id, $double_baking_op_id, $double_consensus_op_id, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->stakingGetStakingUpdatesCountRequest($id, $level, $timestamp, $cycle, $baker, $staker, $type, $amount, $pseudotokens, $rounding_error, $autostaking_op_id, $staking_op_id, $delegation_op_id, $double_baking_op_id, $double_consensus_op_id, $contentType);
    ...
    {
        return $this->stakingGetStakingUpdatesCountAsyncWithHttpInfo($id, $level, $timestamp, $cycle, $baker, $staker, $type, $amount, $pseudotokens, $rounding_error, $autostaking_op_id, $staking_op_id, $delegation_op_id, $double_baking_op_id, $double_consensus_op_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  \Tzkt\Model\AccountsGetActivityTimestampParameter|null $first_time Filter by timestamp (ISO 8601) of the block where the unstake request was created.   Click on the parameter to expand more details. (optional)
     ...
     * @param  \Tzkt\Model\AccountsGetActivityTimestampParameter|null $last_time Filter by timestamp (ISO 8601) of the block where the unstake request was last updated.   Click on the parameter to expand more details. (optional)
     * @param  \Tzkt\Model\AccountsGetSortParameter|null $sort Sorts items (asc or desc) by the specified field. You can see what fields can be used for sorting in the response description, below.   Click on the parameter to expand more details. (optional)
     * @param  \Tzkt\Model\AccountsGetOffsetParameter|null $offset Specifies which or how many items should be skipped.   Click on the parameter to expand more details. (optional)
     * @param  int|null $limit Maximum number of items to return. (optional)
     * @param  \Tzkt\Model\BigMapsGetBigMapKeysSelectParameter|null $select Specify a comma-separated list of fields to include into response or leave it undefined to get default set of fields. This parameter accepts values of the following format: &#x60;{field}{path?}{as alias?}&#x60;, so you can do deep selection (for example, &#x60;?select&#x3D;balance,token.metadata.symbol as token,...&#x60;).   Note, if you select just one field, the response will be flatten into a simple array of values.   Click on the parameter to expand the details. (optional)
