...
class HelpersApi
{
     ...
     * @param  bool|null $async If &#x60;true&#x60;, the function returns immediately. Otherwise, the operation will be validated before the result is returned. (optional, default to true)
     ...
     * @return string
     */
    public function helpersPostInject(
        string $body,
        ?bool $async = true,
        string $contentType = self::contentTypes['helpersPostInject'][0]
    ): string
    {
     ...
     */
    public function helpersPostInjectWithHttpInfo(
        string $body,
        ?bool $async = true,
        string $contentType = self::contentTypes['helpersPostInject'][0]
    ): array
     ...
     */
    public function helpersPostInjectAsync(
        string $body,
        ?bool $async = true,
        string $contentType = self::contentTypes['helpersPostInject'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function helpersPostInjectAsyncWithHttpInfo(
        string $body,
        ?bool $async = true,
        string $contentType = self::contentTypes['helpersPostInject'][0]
    ): PromiseInterface
     ...
     */
    public function helpersPostInjectRequest(
        string $body,
        ?bool $async = true,
        string $contentType = self::contentTypes['helpersPostInject'][0]
    ): Request
     ...
     */
    public function helpersPostRunScriptView(
        string $contract,
        string $name,
        mixed $body,
        string $contentType = self::contentTypes['helpersPostRunScriptView'][0]
    ): \SplFileObject
    {
     ...
     */
    public function helpersPostRunScriptViewWithHttpInfo(
        string $contract,
        string $name,
        mixed $body,
        string $contentType = self::contentTypes['helpersPostRunScriptView'][0]
     ...
     * @return PromiseInterface
     */
    public function helpersPostRunScriptViewAsync(
        string $contract,
        string $name,
        mixed $body,
        string $contentType = self::contentTypes['helpersPostRunScriptView'][0]
     ...
     * @return PromiseInterface
     */
    public function helpersPostRunScriptViewAsyncWithHttpInfo(
        string $contract,
        string $name,
        mixed $body,
        string $contentType = self::contentTypes['helpersPostRunScriptView'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function helpersPostRunScriptViewRequest(
        string $contract,
        string $name,
        mixed $body,
        string $contentType = self::contentTypes['helpersPostRunScriptView'][0]
