...
class RightsApi
{
     ...
     * Get rights
     *
     * @param  \Tzkt\Model\RightsGetCountTypeParameter|null $type Filters rights by type (&#x60;baking&#x60;, &#x60;attestation&#x60;) (optional)
    ...
    public function rightsGet(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ...
        ?\Tzkt\Model\CommitmentsGetAllActivationLevelParameter $slots = null,
        ?\Tzkt\Model\CommitmentsGetAllActivationLevelParameter $round = null,
        ?\Tzkt\Model\RightsGetCountStatusParameter $status = null,
        ...
        ?int $limit = 100,
        string $contentType = self::contentTypes['rightsGet'][0]
    ): array
    {
        list($response) = $this->rightsGetWithHttpInfo($type, $baker, $cycle, $level, $slots, $round, $status, $select, $sort, $offset, $limit, $contentType);
        return $response;
    }
     ...
     */
    public function rightsGetWithHttpInfo(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
    ...
    {
        $request = $this->rightsGetRequest($type, $baker, $cycle, $level, $slots, $round, $status, $select, $sort, $offset, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\BakingRight[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function rightsGetAsync(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
    ...
    {
        return $this->rightsGetAsyncWithHttpInfo($type, $baker, $cycle, $level, $slots, $round, $status, $select, $sort, $offset, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function rightsGetAsyncWithHttpInfo(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
     ...
     */
    public function rightsGetRequest(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
     ...
     * @return int
     */
    public function rightsGetCount(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
        ...
        ?\Tzkt\Model\CommitmentsGetAllActivationLevelParameter $round = null,
        ?\Tzkt\Model\RightsGetCountStatusParameter $status = null,
        string $contentType = self::contentTypes['rightsGetCount'][0]
    ): int
    {
        list($response) = $this->rightsGetCountWithHttpInfo($type, $baker, $cycle, $level, $slots, $round, $status, $contentType);
        return $response;
    }
     ...
     */
    public function rightsGetCountWithHttpInfo(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
    ...
    {
        $request = $this->rightsGetCountRequest($type, $baker, $cycle, $level, $slots, $round, $status, $contentType);
     ...
     * @return PromiseInterface
     */
    public function rightsGetCountAsync(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
    ...
    {
        return $this->rightsGetCountAsyncWithHttpInfo($type, $baker, $cycle, $level, $slots, $round, $status, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function rightsGetCountAsyncWithHttpInfo(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function rightsGetCountRequest(
        ?\Tzkt\Model\RightsGetCountTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $baker = null,
        ?\Tzkt\Model\AccountsGetIdParameter $cycle = null,
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
