...
class CommitmentsApi
{
     ...
     * @return \Tzkt\Model\Commitment
     */
    public function commitmentsGet(
        string $address,
        string $contentType = self::contentTypes['commitmentsGet'][0]
    ): \Tzkt\Model\Commitment
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tzkt\Model\Commitment, HTTP status code, HTTP response headers (array of strings)
     */
    public function commitmentsGetWithHttpInfo(
        string $address,
        string $contentType = self::contentTypes['commitmentsGet'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\Commitment', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Tzkt\Model\Commitment' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tzkt\Model\Commitment', []),
            ...
            $returnType = '\Tzkt\Model\Commitment';
     ...
     */
    public function commitmentsGetAsync(
        string $address,
        string $contentType = self::contentTypes['commitmentsGet'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function commitmentsGetAsyncWithHttpInfo(
        string $address,
        string $contentType = self::contentTypes['commitmentsGet'][0]
    ): PromiseInterface
    {
     ...
     */
    public function commitmentsGetRequest(
        string $address,
        string $contentType = self::contentTypes['commitmentsGet'][0]
    ): Request
    {
     ...
     * Get commitments
     *
     * @param  bool|null $activated Filters commitments by activation status (optional)
     * @param  \Tzkt\Model\CommitmentsGetAllActivationLevelParameter|null $activation_level Filters commitments by activation level (optional)
     * @param  \Tzkt\Model\AccountsGetBalanceParameter|null $balance Filters commitments by activated balance (optional)
     ...
     * @param  \Tzkt\Model\AccountsGetSortParameter|null $sort Sorts delegators by specified field. Supported fields: &#x60;id&#x60; (default), &#x60;balance&#x60;, &#x60;activationLevel&#x60;. (optional)
     ...
     * @return \Tzkt\Model\Commitment[]
     */
    public function commitmentsGetAll(
        ?bool $activated = null,
        ?\Tzkt\Model\CommitmentsGetAllActivationLevelParameter $activation_level = null,
        ...
        ?int $limit = 100,
        string $contentType = self::contentTypes['commitmentsGetAll'][0]
    ): array
    {
     ...
     * @return array of \Tzkt\Model\Commitment[], HTTP status code, HTTP response headers (array of strings)
     */
    public function commitmentsGetAllWithHttpInfo(
        ?bool $activated = null,
        ?\Tzkt\Model\CommitmentsGetAllActivationLevelParameter $activation_level = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
     ...
     * @return PromiseInterface
     */
    public function commitmentsGetAllAsync(
        ?bool $activated = null,
        ?\Tzkt\Model\CommitmentsGetAllActivationLevelParameter $activation_level = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
     ...
     * @return PromiseInterface
     */
    public function commitmentsGetAllAsyncWithHttpInfo(
        ?bool $activated = null,
        ?\Tzkt\Model\CommitmentsGetAllActivationLevelParameter $activation_level = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function commitmentsGetAllRequest(
        ?bool $activated = null,
        ?\Tzkt\Model\CommitmentsGetAllActivationLevelParameter $activation_level = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
     ...
     * @return int
     */
    public function commitmentsGetCount(
        ?bool $activated = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        string $contentType = self::contentTypes['commitmentsGetCount'][0]
    ): int
    {
     ...
     */
    public function commitmentsGetCountWithHttpInfo(
        ?bool $activated = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        string $contentType = self::contentTypes['commitmentsGetCount'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function commitmentsGetCountAsync(
        ?bool $activated = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        string $contentType = self::contentTypes['commitmentsGetCount'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function commitmentsGetCountAsyncWithHttpInfo(
        ?bool $activated = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        string $contentType = self::contentTypes['commitmentsGetCount'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function commitmentsGetCountRequest(
        ?bool $activated = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        string $contentType = self::contentTypes['commitmentsGetCount'][0]
    ): Request
