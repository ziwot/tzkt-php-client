...
class CyclesApi
{
     ...
     * @param  \Tzkt\Model\AccountsGetSortParameter|null $sort Sorts cycles by specified field. Supported fields: &#x60;index&#x60; (default, desc). (optional)
     ...
     * @return \Tzkt\Model\Cycle[]
     */
    public function cyclesGet(
        ...
        string $contentType = self::contentTypes['cyclesGet'][0]
    ): array
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tzkt\Model\Cycle[], HTTP status code, HTTP response headers (array of strings)
     */
    public function cyclesGetWithHttpInfo(
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\Cycle[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Tzkt\Model\Cycle[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tzkt\Model\Cycle[]', []),
     ...
     */
    public function cyclesGetAsync(
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
     ...
     * @return PromiseInterface
     */
    public function cyclesGetAsyncWithHttpInfo(
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
     ...
     */
    public function cyclesGetRequest(
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
     ...
     * @return \Tzkt\Model\Cycle
     */
    public function cyclesGetByIndex(
        int $index,
        ?\Tzkt\Model\AccountsGetOperationsQuoteParameter $quote = null,
        string $contentType = self::contentTypes['cyclesGetByIndex'][0]
    ): \Tzkt\Model\Cycle
    {
     ...
     * @return array of \Tzkt\Model\Cycle, HTTP status code, HTTP response headers (array of strings)
     */
    public function cyclesGetByIndexWithHttpInfo(
        int $index,
        ?\Tzkt\Model\AccountsGetOperationsQuoteParameter $quote = null,
        string $contentType = self::contentTypes['cyclesGetByIndex'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function cyclesGetByIndexAsync(
        int $index,
        ?\Tzkt\Model\AccountsGetOperationsQuoteParameter $quote = null,
        string $contentType = self::contentTypes['cyclesGetByIndex'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function cyclesGetByIndexAsyncWithHttpInfo(
        int $index,
        ?\Tzkt\Model\AccountsGetOperationsQuoteParameter $quote = null,
        string $contentType = self::contentTypes['cyclesGetByIndex'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cyclesGetByIndexRequest(
        int $index,
        ?\Tzkt\Model\AccountsGetOperationsQuoteParameter $quote = null,
        string $contentType = self::contentTypes['cyclesGetByIndex'][0]
    ): Request
    ...
    public function cyclesGetCount(
        string $contentType = self::contentTypes['cyclesGetCount'][0]
    ): int
    {
