...
class DelegatesApi
{
     ...
     * Get delegates
     *
     * @param  \Tzkt\Model\AccountsGetStakedParameter|null $active Delegate status to filter by (true - only active, false - only deactivated, undefined - all delegates) (optional)
     * @param  \Tzkt\Model\AccountsGetIdParameter|null $last_activity Filters delegates by last activity level (where the delegate was updated) (optional)
     ...
     * @param  \Tzkt\Model\AccountsGetSortParameter|null $sort Sorts delegators by specified field. Supported fields: &#x60;id&#x60; (default), &#x60;stakedBalance&#x60;, &#x60;externalStakedBalance&#x60;, &#x60;ownDelegatedBalance&#x60;, &#x60;externalDelegatedBalance&#x60;, &#x60;bakingPower&#x60;, &#x60;votingPower&#x60;, &#x60;balance&#x60;, &#x60;numDelegators&#x60;, &#x60;stakersCount&#x60;, &#x60;activationLevel&#x60;, &#x60;deactivationLevel&#x60;. (optional)
     ...
     * @return \Tzkt\Model\Delegate[]
     */
    public function delegatesGet(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        ...
        ?int $limit = 100,
        string $contentType = self::contentTypes['delegatesGet'][0]
    ): array
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tzkt\Model\Delegate[], HTTP status code, HTTP response headers (array of strings)
     */
    public function delegatesGetWithHttpInfo(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        ?\Tzkt\Model\AccountsGetIdParameter $last_activity = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\Delegate[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Tzkt\Model\Delegate[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tzkt\Model\Delegate[]', []),
            ...
            $returnType = '\Tzkt\Model\Delegate[]';
     ...
     */
    public function delegatesGetAsync(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        ?\Tzkt\Model\AccountsGetIdParameter $last_activity = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
     ...
     * @return PromiseInterface
     */
    public function delegatesGetAsyncWithHttpInfo(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        ?\Tzkt\Model\AccountsGetIdParameter $last_activity = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
     ...
     */
    public function delegatesGetRequest(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        ?\Tzkt\Model\AccountsGetIdParameter $last_activity = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
     ...
     * @return \Tzkt\Model\Delegate
     */
    public function delegatesGetByAddress(
        string $address,
        string $contentType = self::contentTypes['delegatesGetByAddress'][0]
    ): \Tzkt\Model\Delegate
    {
     ...
     * @return array of \Tzkt\Model\Delegate, HTTP status code, HTTP response headers (array of strings)
     */
    public function delegatesGetByAddressWithHttpInfo(
        string $address,
        string $contentType = self::contentTypes['delegatesGetByAddress'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function delegatesGetByAddressAsync(
        string $address,
        string $contentType = self::contentTypes['delegatesGetByAddress'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function delegatesGetByAddressAsyncWithHttpInfo(
        string $address,
        string $contentType = self::contentTypes['delegatesGetByAddress'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function delegatesGetByAddressRequest(
        string $address,
        string $contentType = self::contentTypes['delegatesGetByAddress'][0]
    ): Request
    {
     ...
     * @return int
     */
    public function delegatesGetCount(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        string $contentType = self::contentTypes['delegatesGetCount'][0]
    ): int
    {
     ...
     */
    public function delegatesGetCountWithHttpInfo(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        string $contentType = self::contentTypes['delegatesGetCount'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function delegatesGetCountAsync(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        string $contentType = self::contentTypes['delegatesGetCount'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function delegatesGetCountAsyncWithHttpInfo(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        string $contentType = self::contentTypes['delegatesGetCount'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function delegatesGetCountRequest(
        ?\Tzkt\Model\AccountsGetStakedParameter $active = null,
        string $contentType = self::contentTypes['delegatesGetCount'][0]
    ): Request
    {
