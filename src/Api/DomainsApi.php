...
class DomainsApi
{
     ...
     * @param  \Tzkt\Model\BigMapsGetBigMapsPathParameter|null $name Filter by the domain name.   Click on the parameter to expand more details. (optional)
     ...
     * @param  \Tzkt\Model\BlocksGetTimestampParameter|null $expiration Filter by the domain expiration.   Click on the parameter to expand more details. (optional)
     * @param  \Tzkt\Model\BigMapsGetBigMapKeysKeyParameter|null $data Filter by the domain data.   Note, this parameter supports the following format: &#x60;data{.path?}{.mode?}&#x3D;...&#x60;, so you can specify a path to a particular field to filter by (for example, &#x60;?data.foo&#x3D;bar&#x60;).   Click on the parameter to expand more details. (optional)
     ...
     * @param  \Tzkt\Model\AccountsGetActivityTimestampParameter|null $first_time Filter by timestamp (ISO 8601) of the block where the domain was first seen.   Click on the parameter to expand more details. (optional)
     ...
     * @param  \Tzkt\Model\AccountsGetActivityTimestampParameter|null $last_time Filter by timestamp (ISO 8601) of the block where the domain was last seen.   Click on the parameter to expand more details. (optional)
    ...
    public function domainsGet(
        ...
        ?\Tzkt\Model\BigMapsGetBigMapsPathParameter $name = null,
        ...
        ?\Tzkt\Model\BlocksGetTimestampParameter $expiration = null,
        ?\Tzkt\Model\BigMapsGetBigMapKeysKeyParameter $data = null,
