...
class QuotesApi
{
     ...
     * Get quotes
     *
     * @param  \Tzkt\Model\AccountsGetIdParameter|null $level Filters quotes by level. (optional)
     * @param  \Tzkt\Model\BlocksGetTimestampParameter|null $timestamp Filters quotes by timestamp. (optional)
     ...
     * @param  \Tzkt\Model\AccountsGetSortParameter|null $sort Sorts quotes by specified field. Supported fields: &#x60;level&#x60; (default). (optional)
     ...
     * @return \Tzkt\Model\Quote[]
     */
    public function quotesGet(
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
        ?\Tzkt\Model\BlocksGetTimestampParameter $timestamp = null,
        ...
        ?int $limit = 100,
        string $contentType = self::contentTypes['quotesGet'][0]
    ): array
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Tzkt\Model\Quote[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\Quote[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Tzkt\Model\Quote[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Tzkt\Model\Quote[]', []),
     ...
     */
    public function quotesGetRequest(
        ?\Tzkt\Model\AccountsGetIdParameter $level = null,
        ?\Tzkt\Model\BlocksGetTimestampParameter $timestamp = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
    ...
    public function quotesGetCount(
        string $contentType = self::contentTypes['quotesGetCount'][0]
    ): int
    {
    ...
    public function quotesGetLast(
        string $contentType = self::contentTypes['quotesGetLast'][0]
    ): \Tzkt\Model\Quote
    {
