...
class AccountsApi
{
    ...
    public function accountsGet(
        ...
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetKindParameter $kind = null,
        ?\Tzkt\Model\AccountsGetDelegateParameter $delegate = null,
        ?\Tzkt\Model\AccountsGetStakedPseudotokensParameter $staked_pseudotokens = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetStakedParameter $staked = null,
        ...
        ?int $limit = 100,
        string $contentType = self::contentTypes['accountsGet'][0]
    ): array
    {
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\Account[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     * @return int
     */
    public function accountsGetBalance(
        string $address,
        string $contentType = self::contentTypes['accountsGetBalance'][0]
    ): int
    {
     ...
     */
    public function accountsGetBalanceWithHttpInfo(
        string $address,
        string $contentType = self::contentTypes['accountsGetBalance'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceAsync(
        string $address,
        string $contentType = self::contentTypes['accountsGetBalance'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceAsyncWithHttpInfo(
        string $address,
        string $contentType = self::contentTypes['accountsGetBalance'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetBalanceRequest(
        string $address,
        string $contentType = self::contentTypes['accountsGetBalance'][0]
    ): Request
    {
     ...
     * @return int
     */
    public function accountsGetBalanceAtDate(
        string $address,
        \DateTime $datetime,
        string $contentType = self::contentTypes['accountsGetBalanceAtDate'][0]
    ): int
    {
     ...
     * @return array of int, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountsGetBalanceAtDateWithHttpInfo(
        string $address,
        \DateTime $datetime,
        string $contentType = self::contentTypes['accountsGetBalanceAtDate'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceAtDateAsync(
        string $address,
        \DateTime $datetime,
        string $contentType = self::contentTypes['accountsGetBalanceAtDate'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceAtDateAsyncWithHttpInfo(
        string $address,
        \DateTime $datetime,
        string $contentType = self::contentTypes['accountsGetBalanceAtDate'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetBalanceAtDateRequest(
        string $address,
        \DateTime $datetime,
        string $contentType = self::contentTypes['accountsGetBalanceAtDate'][0]
    ): Request
     ...
     * @return int
     */
    public function accountsGetBalanceAtLevel(
        string $address,
        int $level,
        string $contentType = self::contentTypes['accountsGetBalanceAtLevel'][0]
    ): int
    {
     ...
     * @return array of int, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountsGetBalanceAtLevelWithHttpInfo(
        string $address,
        int $level,
        string $contentType = self::contentTypes['accountsGetBalanceAtLevel'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceAtLevelAsync(
        string $address,
        int $level,
        string $contentType = self::contentTypes['accountsGetBalanceAtLevel'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceAtLevelAsyncWithHttpInfo(
        string $address,
        int $level,
        string $contentType = self::contentTypes['accountsGetBalanceAtLevel'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetBalanceAtLevelRequest(
        string $address,
        int $level,
        string $contentType = self::contentTypes['accountsGetBalanceAtLevel'][0]
    ): Request
     ...
     */
    public function accountsGetBalanceHistory(
        string $address,
        ?int $step = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
     ...
     */
    public function accountsGetBalanceHistoryWithHttpInfo(
        string $address,
        ?int $step = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\HistoricalBalance[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceHistoryAsync(
        string $address,
        ?int $step = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceHistoryAsyncWithHttpInfo(
        string $address,
        ?int $step = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetBalanceHistoryRequest(
        string $address,
        ?int $step = null,
        ?\Tzkt\Model\AccountsGetSelectParameter $select = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
     ...
     */
    public function accountsGetBalanceReport(
        string $address,
        ?\DateTime $from = null,
        ?\DateTime $to = null,
        ...
        string $contentType = self::contentTypes['accountsGetBalanceReport'][0]
    ): \SplFileObject
    {
     ...
     */
    public function accountsGetBalanceReportWithHttpInfo(
        string $address,
        ?\DateTime $from = null,
        ?\DateTime $to = null,
        ?string $currency = null,
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceReportAsync(
        string $address,
        ?\DateTime $from = null,
        ?\DateTime $to = null,
        ?string $currency = null,
     ...
     * @return PromiseInterface
     */
    public function accountsGetBalanceReportAsyncWithHttpInfo(
        string $address,
        ?\DateTime $from = null,
        ?\DateTime $to = null,
        ?string $currency = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetBalanceReportRequest(
        string $address,
        ?\DateTime $from = null,
        ?\DateTime $to = null,
        ?string $currency = null,
     ...
     */
    public function accountsGetContracts(
        string $address,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
        string $contentType = self::contentTypes['accountsGetContracts'][0]
    ): array
    {
     ...
     */
    public function accountsGetContractsWithHttpInfo(
        string $address,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\RelatedContract[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function accountsGetContractsAsync(
        string $address,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
     ...
     * @return PromiseInterface
     */
    public function accountsGetContractsAsyncWithHttpInfo(
        string $address,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetContractsRequest(
        string $address,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
     ...
     * @return int
     */
    public function accountsGetCount(
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetKindParameter $kind = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetStakedParameter $staked = null,
        ?\Tzkt\Model\AccountsGetIdParameter $first_activity = null,
        string $contentType = self::contentTypes['accountsGetCount'][0]
    ): int
    {
     ...
     * @return array of int, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountsGetCountWithHttpInfo(
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetKindParameter $kind = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetStakedParameter $staked = null,
     ...
     * @return PromiseInterface
     */
    public function accountsGetCountAsync(
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetKindParameter $kind = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetStakedParameter $staked = null,
     ...
     * @return PromiseInterface
     */
    public function accountsGetCountAsyncWithHttpInfo(
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetKindParameter $kind = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetStakedParameter $staked = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetCountRequest(
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetKindParameter $kind = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetStakedParameter $staked = null,
     ...
     * @return int
     */
    public function accountsGetCounter(
        string $address,
        string $contentType = self::contentTypes['accountsGetCounter'][0]
    ): int
    {
     ...
     * @return array of int, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountsGetCounterWithHttpInfo(
        string $address,
        string $contentType = self::contentTypes['accountsGetCounter'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function accountsGetCounterAsync(
        string $address,
        string $contentType = self::contentTypes['accountsGetCounter'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function accountsGetCounterAsyncWithHttpInfo(
        string $address,
        string $contentType = self::contentTypes['accountsGetCounter'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetCounterRequest(
        string $address,
        string $contentType = self::contentTypes['accountsGetCounter'][0]
    ): Request
    {
     ...
     */
    public function accountsGetDelegators(
        string $address,
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetIdParameter $delegation_level = null,
        ?\Tzkt\Model\AccountsGetSortParameter $sort = null,
        ?\Tzkt\Model\AccountsGetOffsetParameter $offset = null,
        ?int $limit = 100,
        string $contentType = self::contentTypes['accountsGetDelegators'][0]
    ): array
    {
     ...
     */
    public function accountsGetDelegatorsWithHttpInfo(
        string $address,
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetIdParameter $delegation_level = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Tzkt\Model\Delegator[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function accountsGetDelegatorsAsync(
        string $address,
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetIdParameter $delegation_level = null,
     ...
     * @return PromiseInterface
     */
    public function accountsGetDelegatorsAsyncWithHttpInfo(
        string $address,
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetIdParameter $delegation_level = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetDelegatorsRequest(
        string $address,
        ?\Tzkt\Model\AccountsGetTypeParameter $type = null,
        ?\Tzkt\Model\AccountsGetBalanceParameter $balance = null,
        ?\Tzkt\Model\AccountsGetIdParameter $delegation_level = null,
