...
class ConstantsApi
{
     ...
     * @param  \Tzkt\Model\AccountsGetActivityTimestampParameter|null $creation_time Filters constants by creation time. (optional)
    ...
    public function constantsGet(
        ...
        ?\Tzkt\Model\AccountsGetActivityTimestampParameter $creation_time = null,
