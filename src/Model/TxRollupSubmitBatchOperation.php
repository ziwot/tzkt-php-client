 ...
 */
class TxRollupSubmitBatchOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TxRollupSubmitBatchOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\TxRollupSubmitBatchOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'baker_fee' => 'int',
        'storage_fee' => 'int',
        'rollup' => '\Tzkt\Model\TxRollupSubmitBatchOperationAllOfRollup',
        'status' => 'string',
        'errors' => '\Tzkt\Model\OperationError[]',
        'quote' => '\Tzkt\Model\TxRollupSubmitBatchOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\TxRollupSubmitBatchOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\TxRollupSubmitBatchOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\TxRollupSubmitBatchOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\TxRollupSubmitBatchOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Gets rollup
     *
     * @return \Tzkt\Model\TxRollupSubmitBatchOperationAllOfRollup|null
     */
    public function getRollup(): ?\Tzkt\Model\TxRollupSubmitBatchOperationAllOfRollup
    {
     ...
     * Sets rollup
     *
     * @param \Tzkt\Model\TxRollupSubmitBatchOperationAllOfRollup|null $rollup rollup
     *
     * @return $this
     */
    public function setRollup(?\Tzkt\Model\TxRollupSubmitBatchOperationAllOfRollup $rollup): static
    {
        if (is_null($rollup)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\TxRollupSubmitBatchOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\TxRollupSubmitBatchOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\TxRollupSubmitBatchOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\TxRollupSubmitBatchOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
