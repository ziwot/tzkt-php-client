<?php
/**
 * DoubleConsensusOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * DoubleConsensusOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class DoubleConsensusOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DoubleConsensusOperation_allOf_quote';
