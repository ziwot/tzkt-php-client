...
class UnstakeRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'staker' => '\Tzkt\Model\UnstakeRequestStaker',
    ...
    protected static array $setters = [
        ...
        'status' => 'setStatus',
        'unlock_cycle' => 'setUnlockCycle',
        'unlock_level' => 'setUnlockLevel',
    ...
    protected static array $getters = [
        ...
        'status' => 'getStatus',
        'unlock_cycle' => 'getUnlockCycle',
        'unlock_level' => 'getUnlockLevel',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('unlock_cycle', $data ?? [], null);
        $this->setIfExists('unlock_level', $data ?? [], null);
    ...
    */
     ...
     * Gets staker
     *
     * @return \Tzkt\Model\UnstakeRequestStaker|null
     */
    public function getStaker(): ?\Tzkt\Model\UnstakeRequestStaker
    {
     ...
     * Sets staker
     *
     * @param \Tzkt\Model\UnstakeRequestStaker|null $staker staker
     *
     * @return $this
     */
    public function setStaker(?\Tzkt\Model\UnstakeRequestStaker $staker): static
    {
        if (is_null($staker)) {
     ...
     * @return int|null
     */
    public function getUnlockCycle(): ?int
    {
        return $this->container['unlock_cycle'];
    }

    /**
     * Sets unlock_cycle
     *
     * @param int|null $unlock_cycle Cycle at which the unstake request will become finalizable
     *
     * @return $this
     */
    public function setUnlockCycle(?int $unlock_cycle): static
    {
        if (is_null($unlock_cycle)) {
            throw new InvalidArgumentException('non-nullable unlock_cycle cannot be null');
        }
        $this->container['unlock_cycle'] = $unlock_cycle;
    ...
    {
        return $this->container['unlock_level'];
    }

    /**
     * Sets unlock_level
     *
     * @param int|null $unlock_level Level of the block at which the unstake request will become finalizable
     *
     * @return $this
     */
    public function setUnlockLevel(?int $unlock_level): static
    {
        if (is_null($unlock_level)) {
            throw new InvalidArgumentException('non-nullable unlock_level cannot be null');
        }
        $this->container['unlock_level'] = $unlock_level;
     ...
     * Sets unlock_time
     *
     * @param \DateTime|null $unlock_time Timestamp of the block at which the unstake request will become finalizable
     *
     * @return $this
     */
    public function setUnlockTime(?\DateTime $unlock_time): static
    {
