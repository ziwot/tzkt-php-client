...
class ContractEvent implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContractEvent';
    ...
    protected static array $openAPITypes = [
        ...
        'level' => 'int',
        'timestamp' => '\DateTime',
        'contract' => '\Tzkt\Model\ContractEventContract',
        'code_hash' => 'int',
        'tag' => 'string',
        'payload' => 'mixed',
        'transaction_id' => 'int',
    ...
    */
     ...
     * Gets contract
     *
     * @return \Tzkt\Model\ContractEventContract|null
     */
    public function getContract(): ?\Tzkt\Model\ContractEventContract
    {
     ...
     * Sets contract
     *
     * @param \Tzkt\Model\ContractEventContract|null $contract contract
     *
     * @return $this
     */
    public function setContract(?\Tzkt\Model\ContractEventContract $contract): static
    {
        if (is_null($contract)) {
     ...
     * @return $this
     */
    public function setRawPayload(mixed $raw_payload): static
    {
