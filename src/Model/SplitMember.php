 ...
 */
class SplitMember implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SplitMember';
    ...
    */
     ...
     *
     * @param string|null $staked_pseudotokens Amount of staked pseudotokens at the snapshot time, representing staker's share within the baker's `externalStakedBalance`.
     *
     * @return $this
     */
