...
class ProtocolConstants implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPIFormats = [
        ...
        'delegation_power_divider' => 'int32',
    ...
    protected static array $openAPINullables = [
        ...
        'delegation_power_divider' => false,
    ...
    protected static array $attributeMap = [
        ...
        'delegation_power_divider' => 'delegationPowerDivider',
    ...
    protected static array $setters = [
        ...
        'delegation_power_divider' => 'setDelegationPowerDivider',
    ...
    protected static array $getters = [
        ...
        'delegation_power_divider' => 'getDelegationPowerDivider',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('delegation_power_divider', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets delegation_power_divider
     *
     * @return int|null
     */
    public function getDelegationPowerDivider(): ?int
    {
        return $this->container['delegation_power_divider'];
    }

    /**
     * Sets delegation_power_divider
     *
     * @param int|null $delegation_power_divider The divider by which delegation power is divided
     *
     * @return $this
     */
    public function setDelegationPowerDivider(?int $delegation_power_divider): static
    {
        if (is_null($delegation_power_divider)) {
            throw new InvalidArgumentException('non-nullable delegation_power_divider cannot be null');
        }
        $this->container['delegation_power_divider'] = $delegation_power_divider;
