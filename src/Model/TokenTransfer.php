...
class TokenTransfer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'level' => 'int',
        'timestamp' => '\DateTime',
        'token' => '\Tzkt\Model\TokenBalanceToken',
        'from' => '\Tzkt\Model\TicketTransferFrom',
        'to' => '\Tzkt\Model\TokenTransferTo',
        'amount' => 'string',
        'transaction_id' => 'int',
        'origination_id' => 'int',
        'migration_id' => 'int'
    ...
    */
     ...
     * Gets token
     *
     * @return \Tzkt\Model\TokenBalanceToken|null
     */
    public function getToken(): ?\Tzkt\Model\TokenBalanceToken
    {
     ...
     * Sets token
     *
     * @param \Tzkt\Model\TokenBalanceToken|null $token token
     *
     * @return $this
     */
    public function setToken(?\Tzkt\Model\TokenBalanceToken $token): static
    {
        if (is_null($token)) {
     ...
     * Gets to
     *
     * @return \Tzkt\Model\TokenTransferTo|null
     */
    public function getTo(): ?\Tzkt\Model\TokenTransferTo
    {
     ...
     * Sets to
     *
     * @param \Tzkt\Model\TokenTransferTo|null $to to
     *
     * @return $this
     */
    public function setTo(?\Tzkt\Model\TokenTransferTo $to): static
    {
        if (is_null($to)) {
