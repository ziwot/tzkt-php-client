<?php
/**
 * AttestationOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * AttestationOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class AttestationOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AttestationOperation_allOf_quote';
