 ...
 */
class TxRollupDispatchTicketsOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TxRollupDispatchTicketsOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'baker_fee' => 'int',
        'storage_fee' => 'int',
        'rollup' => '\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfRollup',
        'status' => 'string',
        'errors' => '\Tzkt\Model\OperationError[]',
        'quote' => '\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\TxRollupDispatchTicketsOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\TxRollupDispatchTicketsOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Gets rollup
     *
     * @return \Tzkt\Model\TxRollupDispatchTicketsOperationAllOfRollup|null
     */
    public function getRollup(): ?\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfRollup
    {
     ...
     * Sets rollup
     *
     * @param \Tzkt\Model\TxRollupDispatchTicketsOperationAllOfRollup|null $rollup rollup
     *
     * @return $this
     */
    public function setRollup(?\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfRollup $rollup): static
    {
        if (is_null($rollup)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\TxRollupDispatchTicketsOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\TxRollupDispatchTicketsOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\TxRollupDispatchTicketsOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
