 ...
 */
class ActivationOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActivationOperation';
    ...
    */
     ...
     */
    public function getAccount(): ?\Tzkt\Model\ActivationOperationAllOfAccount
    {
     ...
     * @return $this
     */
    public function setAccount(?\Tzkt\Model\ActivationOperationAllOfAccount $account): static
    {
        if (is_null($account)) {
     ...
     */
    public function getQuote(): ?\Tzkt\Model\ActivationOperationAllOfQuote
    {
     ...
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\ActivationOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
