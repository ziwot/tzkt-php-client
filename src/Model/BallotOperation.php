 ...
 */
class BallotOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BallotOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'period' => '\Tzkt\Model\BallotOperationAllOfPeriod',
        'proposal' => '\Tzkt\Model\BallotOperationAllOfProposal',
        'delegate' => '\Tzkt\Model\BallotOperationAllOfDelegate',
        'voting_power' => 'int',
        'vote' => 'string',
        'quote' => '\Tzkt\Model\BallotOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets period
     *
     * @return \Tzkt\Model\BallotOperationAllOfPeriod|null
     */
    public function getPeriod(): ?\Tzkt\Model\BallotOperationAllOfPeriod
    {
     ...
     * Sets period
     *
     * @param \Tzkt\Model\BallotOperationAllOfPeriod|null $period period
     *
     * @return $this
     */
    public function setPeriod(?\Tzkt\Model\BallotOperationAllOfPeriod $period): static
    {
        if (is_null($period)) {
     ...
     * Gets proposal
     *
     * @return \Tzkt\Model\BallotOperationAllOfProposal|null
     */
    public function getProposal(): ?\Tzkt\Model\BallotOperationAllOfProposal
    {
     ...
     * Sets proposal
     *
     * @param \Tzkt\Model\BallotOperationAllOfProposal|null $proposal proposal
     *
     * @return $this
     */
    public function setProposal(?\Tzkt\Model\BallotOperationAllOfProposal $proposal): static
    {
        if (is_null($proposal)) {
     ...
     * Gets delegate
     *
     * @return \Tzkt\Model\BallotOperationAllOfDelegate|null
     */
    public function getDelegate(): ?\Tzkt\Model\BallotOperationAllOfDelegate
    {
     ...
     * Sets delegate
     *
     * @param \Tzkt\Model\BallotOperationAllOfDelegate|null $delegate delegate
     *
     * @return $this
     */
    public function setDelegate(?\Tzkt\Model\BallotOperationAllOfDelegate $delegate): static
    {
        if (is_null($delegate)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\BallotOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\BallotOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\BallotOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\BallotOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
