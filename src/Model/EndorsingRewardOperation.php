...
class EndorsingRewardOperation extends Operation
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EndorsingRewardOperation';
    ...
    */
     ...
     */
    public function getBaker(): ?\Tzkt\Model\EndorsingRewardOperationAllOfBaker
    {
     ...
     * @return $this
     */
    public function setBaker(?\Tzkt\Model\EndorsingRewardOperationAllOfBaker $baker): static
    {
        if (is_null($baker)) {
     ...
     */
    public function getQuote(): ?\Tzkt\Model\EndorsingRewardOperationAllOfQuote
    {
     ...
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\EndorsingRewardOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
