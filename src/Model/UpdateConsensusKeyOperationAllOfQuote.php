<?php
/**
 * UpdateConsensusKeyOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * UpdateConsensusKeyOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class UpdateConsensusKeyOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateConsensusKeyOperation_allOf_quote';
