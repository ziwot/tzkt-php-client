<?php
/**
 * TxRollupRejectionOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * TxRollupRejectionOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class TxRollupRejectionOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TxRollupRejectionOperation_allOf_quote';
