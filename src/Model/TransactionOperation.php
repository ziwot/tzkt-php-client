 ...
 */
class TransactionOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TransactionOperation';
    ...
    */
     ...
     */
    public function getInitiator(): ?\Tzkt\Model\TransactionOperationAllOfInitiator
    {
     ...
     * @return $this
     */
    public function setInitiator(?\Tzkt\Model\TransactionOperationAllOfInitiator $initiator): static
    {
     ...
     */
    public function getSender(): ?\Tzkt\Model\TransactionOperationAllOfSender
    {
     ...
     * @return $this
     */
    public function setSender(?\Tzkt\Model\TransactionOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     */
    public function getTarget(): ?\Tzkt\Model\TransactionOperationAllOfTarget
    {
     ...
     * @return $this
     */
    public function setTarget(?\Tzkt\Model\TransactionOperationAllOfTarget $target): static
    {
        if (is_null($target)) {
     ...
     * @return int|null
     */
    public function getTargetCodeHash(): ?int
    {
     ...
     * @return $this
     */
    public function setTargetCodeHash(?int $target_code_hash): static
    {
     ...
     */
    public function getParameter(): ?\Tzkt\Model\TransactionOperationAllOfParameter
    {
     ...
     * @return $this
     */
    public function setParameter(?\Tzkt\Model\TransactionOperationAllOfParameter $parameter): static
    {
     ...
     * @return bool|null
     */
    public function getHasInternals(): ?bool
    {
     ...
     * @return $this
     */
    public function setHasInternals(?bool $has_internals): static
    {
     ...
     * @return $this
     */
    public function setEventsCount(?int $events_count): static
    {
     ...
     */
    public function getQuote(): ?\Tzkt\Model\TransactionOperationAllOfQuote
    {
     ...
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\TransactionOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
