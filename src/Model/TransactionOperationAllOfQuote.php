<?php
/**
 * TransactionOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * TransactionOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class TransactionOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TransactionOperation_allOf_quote';
