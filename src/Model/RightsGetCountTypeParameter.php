...
class RightsGetCountTypeParameter implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Rights_GetCount_type_parameter';
    ...
    */
     ...
     * Sets ne
     *
     * @param string|null $ne **Not equal** filter mode. \\ Specify baking right type to get items where the specified field is not equal to the specified value.  Example: `?type.ne=attestation`.
     *
     * @return $this
     */
