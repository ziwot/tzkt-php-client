 ...
 */
class SmartRollupAddMessagesOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SmartRollupAddMessagesOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'timestamp' => '\DateTime',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\SmartRollupAddMessagesOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'quote' => '\Tzkt\Model\SmartRollupAddMessagesOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\SmartRollupAddMessagesOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\SmartRollupAddMessagesOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\SmartRollupAddMessagesOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\SmartRollupAddMessagesOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\SmartRollupAddMessagesOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\SmartRollupAddMessagesOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\SmartRollupAddMessagesOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\SmartRollupAddMessagesOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
