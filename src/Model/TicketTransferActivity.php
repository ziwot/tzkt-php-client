...
/**
 * TicketTransferActivity Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TicketTransferActivity implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TicketTransferActivity';
    ...
    protected static array $openAPITypes = [
        ...
        'level' => 'int',
        'timestamp' => '\DateTime',
        'ticket' => '\Tzkt\Model\TicketTransferActivityAllOfTicket',
        'from' => '\Tzkt\Model\TicketTransferActivityAllOfFrom',
        'to' => '\Tzkt\Model\TicketTransferActivityAllOfTo',
        'amount' => 'string',
        'transaction_id' => 'int',
    ...
    */
     ...
     * Gets ticket
     *
     * @return \Tzkt\Model\TicketTransferActivityAllOfTicket|null
     */
    public function getTicket(): ?\Tzkt\Model\TicketTransferActivityAllOfTicket
    {
     ...
     * Sets ticket
     *
     * @param \Tzkt\Model\TicketTransferActivityAllOfTicket|null $ticket ticket
     *
     * @return $this
     */
    public function setTicket(?\Tzkt\Model\TicketTransferActivityAllOfTicket $ticket): static
    {
        if (is_null($ticket)) {
     ...
     * Gets from
     *
     * @return \Tzkt\Model\TicketTransferActivityAllOfFrom|null
     */
    public function getFrom(): ?\Tzkt\Model\TicketTransferActivityAllOfFrom
    {
     ...
     * Sets from
     *
     * @param \Tzkt\Model\TicketTransferActivityAllOfFrom|null $from from
     *
     * @return $this
     */
    public function setFrom(?\Tzkt\Model\TicketTransferActivityAllOfFrom $from): static
    {
        if (is_null($from)) {
     ...
     * Gets to
     *
     * @return \Tzkt\Model\TicketTransferActivityAllOfTo|null
     */
    public function getTo(): ?\Tzkt\Model\TicketTransferActivityAllOfTo
    {
     ...
     * Sets to
     *
     * @param \Tzkt\Model\TicketTransferActivityAllOfTo|null $to to
     *
     * @return $this
     */
    public function setTo(?\Tzkt\Model\TicketTransferActivityAllOfTo $to): static
    {
        if (is_null($to)) {
