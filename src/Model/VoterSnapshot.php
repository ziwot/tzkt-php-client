...
class VoterSnapshot implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VoterSnapshot';
    ...
    protected static array $openAPITypes = [
        'delegate' => '\Tzkt\Model\VoterSnapshotDelegate',
        'voting_power' => 'int',
        'status' => 'string'
    ];
    ...
    */
     ...
     * Gets delegate
     *
     * @return \Tzkt\Model\VoterSnapshotDelegate|null
     */
    public function getDelegate(): ?\Tzkt\Model\VoterSnapshotDelegate
    {
     ...
     * Sets delegate
     *
     * @param \Tzkt\Model\VoterSnapshotDelegate|null $delegate delegate
     *
     * @return $this
     */
    public function setDelegate(?\Tzkt\Model\VoterSnapshotDelegate $delegate): static
    {
        if (is_null($delegate)) {
