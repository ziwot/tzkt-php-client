...
class RevelationPenaltyOperation extends Operation
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RevelationPenaltyOperation';
    ...
    */
     ...
     */
    public function getBaker(): ?\Tzkt\Model\RevelationPenaltyOperationAllOfBaker
    {
     ...
     * @return $this
     */
    public function setBaker(?\Tzkt\Model\RevelationPenaltyOperationAllOfBaker $baker): static
    {
        if (is_null($baker)) {
     ...
     * @return int|null
     */
    public function getMissedLevel(): ?int
    {
     ...
     * @return $this
     */
    public function setMissedLevel(?int $missed_level): static
    {
     ...
     */
    public function getQuote(): ?\Tzkt\Model\RevelationPenaltyOperationAllOfQuote
    {
     ...
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\RevelationPenaltyOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
     ...
     * @return int|null
     */
    public function getLostReward(): ?int
    {
     ...
     * @return $this
     */
    public function setLostReward(?int $lost_reward): static
    {
     ...
     * @return int|null
     */
    public function getLostFees(): ?int
    {
     ...
     * @return $this
     */
    public function setLostFees(?int $lost_fees): static
    {
