<?php
/**
 * DalEntrapmentEvidenceOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * DalEntrapmentEvidenceOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class DalEntrapmentEvidenceOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DalEntrapmentEvidenceOperation_allOf_quote';
