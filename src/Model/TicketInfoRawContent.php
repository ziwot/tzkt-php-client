...
/**
 * TicketInfoRawContent Class Doc Comment
 *
 ...
 */
class TicketInfoRawContent implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TicketInfo_rawContent';
    ...
    */
     ...
     * Gets type
     *
     * @return \Tzkt\Model\MichelineType|null
     */
    public function getType(): ?\Tzkt\Model\MichelineType
    {
     ...
     * Sets type
     *
     * @param \Tzkt\Model\MichelineType|null $type type
     *
     * @return $this
     */
    public function setType(?\Tzkt\Model\MichelineType $type): static
    {
        if (is_null($type)) {
