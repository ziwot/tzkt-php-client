...
class SplitDelegator implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SplitDelegator';
    ...
    */
     ...
     * @return bool|null
     */
    public function getEmptied(): ?bool
    {
     ...
     * @return $this
     */
    public function setEmptied(?bool $emptied): static
    {
        if (is_null($emptied)) {
     ...
     * @return int|null
     */
    public function getCurrentDelegatedBalance(): ?int
    {
     ...
     * @return $this
     */
    public function setCurrentDelegatedBalance(?int $current_delegated_balance): static
    {
     ...
     * @return int|null
     */
    public function getCurrentStakedBalance(): ?int
    {
     ...
     * @return $this
     */
    public function setCurrentStakedBalance(?int $current_staked_balance): static
    {
     ...
     * @return $this
     */
    public function setCurrentBalance(?int $current_balance): static
    {
