<?php
/**
 * RegisterConstantOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * RegisterConstantOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class RegisterConstantOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RegisterConstantOperation_allOf_quote';
