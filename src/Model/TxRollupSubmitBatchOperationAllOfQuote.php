<?php
/**
 * TxRollupSubmitBatchOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * TxRollupSubmitBatchOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class TxRollupSubmitBatchOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TxRollupSubmitBatchOperation_allOf_quote';
