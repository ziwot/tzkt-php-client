...
class SrGameLastMove implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SrGame_lastMove';
    ...
    protected static array $openAPITypes = [
        ...
        'level' => 'int',
        'timestamp' => '\DateTime',
        'sender' => '\Tzkt\Model\SrGameMoveSender',
        'move' => 'string',
        'game_status' => 'string'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\SrGameMoveSender|null
     */
    public function getSender(): ?\Tzkt\Model\SrGameMoveSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\SrGameMoveSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\SrGameMoveSender $sender): static
    {
        if (is_null($sender)) {
