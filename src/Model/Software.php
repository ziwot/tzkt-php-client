...
class Software implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Software';
    ...
    */
     ...
     * @return $this
     */
    public function setShortHash(?string $short_hash): static
    {
        if (is_null($short_hash)) {
            throw new InvalidArgumentException('non-nullable short_hash cannot be null');
        }
     ...
     * @return $this
     */
    public function setBlocksCount(?int $blocks_count): static
    {
