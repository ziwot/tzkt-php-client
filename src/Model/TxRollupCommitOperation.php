 ...
 */
class TxRollupCommitOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TxRollupCommitOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\TxRollupCommitOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        'baker_fee' => 'int',
        'rollup' => '\Tzkt\Model\TxRollupCommitOperationAllOfRollup',
        'bond' => 'int',
        'status' => 'string',
        'errors' => '\Tzkt\Model\OperationError[]',
        'quote' => '\Tzkt\Model\TxRollupCommitOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\TxRollupCommitOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\TxRollupCommitOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\TxRollupCommitOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\TxRollupCommitOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Gets rollup
     *
     * @return \Tzkt\Model\TxRollupCommitOperationAllOfRollup|null
     */
    public function getRollup(): ?\Tzkt\Model\TxRollupCommitOperationAllOfRollup
    {
     ...
     * Sets rollup
     *
     * @param \Tzkt\Model\TxRollupCommitOperationAllOfRollup|null $rollup rollup
     *
     * @return $this
     */
    public function setRollup(?\Tzkt\Model\TxRollupCommitOperationAllOfRollup $rollup): static
    {
        if (is_null($rollup)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\TxRollupCommitOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\TxRollupCommitOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\TxRollupCommitOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\TxRollupCommitOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
