<?php
/**
 * EndorsingRewardOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * EndorsingRewardOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class EndorsingRewardOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EndorsingRewardOperation_allOf_quote';
