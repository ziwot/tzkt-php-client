 ...
 */
class DrainDelegateOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DrainDelegateOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'delegate' => '\Tzkt\Model\DrainDelegateOperationAllOfDelegate',
        'target' => '\Tzkt\Model\DrainDelegateOperationAllOfTarget',
        'amount' => 'int',
        'fee' => 'int',
        'allocation_fee' => 'int',
        'quote' => '\Tzkt\Model\DrainDelegateOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets delegate
     *
     * @return \Tzkt\Model\DrainDelegateOperationAllOfDelegate|null
     */
    public function getDelegate(): ?\Tzkt\Model\DrainDelegateOperationAllOfDelegate
    {
     ...
     * Sets delegate
     *
     * @param \Tzkt\Model\DrainDelegateOperationAllOfDelegate|null $delegate delegate
     *
     * @return $this
     */
    public function setDelegate(?\Tzkt\Model\DrainDelegateOperationAllOfDelegate $delegate): static
    {
        if (is_null($delegate)) {
     ...
     * Gets target
     *
     * @return \Tzkt\Model\DrainDelegateOperationAllOfTarget|null
     */
    public function getTarget(): ?\Tzkt\Model\DrainDelegateOperationAllOfTarget
    {
     ...
     * Sets target
     *
     * @param \Tzkt\Model\DrainDelegateOperationAllOfTarget|null $target target
     *
     * @return $this
     */
    public function setTarget(?\Tzkt\Model\DrainDelegateOperationAllOfTarget $target): static
    {
        if (is_null($target)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\DrainDelegateOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\DrainDelegateOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\DrainDelegateOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\DrainDelegateOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
