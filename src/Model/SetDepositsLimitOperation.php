 ...
 */
class SetDepositsLimitOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SetDepositsLimitOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\SetDepositsLimitOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'quote' => '\Tzkt\Model\SetDepositsLimitOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\SetDepositsLimitOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\SetDepositsLimitOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\SetDepositsLimitOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\SetDepositsLimitOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\SetDepositsLimitOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\SetDepositsLimitOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\SetDepositsLimitOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\SetDepositsLimitOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
