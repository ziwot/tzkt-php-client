<?php
/**
 * OriginationOperationAllOfOriginatedContract
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * OriginationOperationAllOfOriginatedContract Class Doc Comment
 *
 ...
 */
class OriginationOperationAllOfOriginatedContract implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OriginationOperation_allOf_originatedContract';
