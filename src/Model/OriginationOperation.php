...
class OriginationOperation extends Operation
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OriginationOperation';
    ...
    */
     ...
     */
    public function getInitiator(): ?\Tzkt\Model\OriginationOperationAllOfInitiator
    {
     ...
     * @return $this
     */
    public function setInitiator(?\Tzkt\Model\OriginationOperationAllOfInitiator $initiator): static
    {
     ...
     */
    public function getSender(): ?\Tzkt\Model\OriginationOperationAllOfSender
    {
     ...
     * @return $this
     */
    public function setSender(?\Tzkt\Model\OriginationOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * @return int|null
     */
    public function getAllocationFee(): ?int
    {
     ...
     * @return $this
     */
    public function setAllocationFee(?int $allocation_fee): static
    {
     ...
     * @return int|null
     */
    public function getContractBalance(): ?int
    {
     ...
     * @return $this
     */
    public function setContractBalance(?int $contract_balance): static
    {
     ...
     */
    public function getContractManager(): ?\Tzkt\Model\OriginationOperationAllOfContractManager
    {
     ...
     * @return $this
     */
    public function setContractManager(?\Tzkt\Model\OriginationOperationAllOfContractManager $contract_manager): static
    {
     ...
     */
    public function getContractDelegate(): ?\Tzkt\Model\OriginationOperationAllOfContractDelegate
    {
     ...
     * @return $this
     */
    public function setContractDelegate(?\Tzkt\Model\OriginationOperationAllOfContractDelegate $contract_delegate): static
    {
     ...
     */
    public function getOriginatedContract(): ?\Tzkt\Model\OriginationOperationAllOfOriginatedContract
    {
     ...
     * @return $this
     */
    public function setOriginatedContract(?\Tzkt\Model\OriginationOperationAllOfOriginatedContract $originated_contract): static
    {
     ...
     */
    public function getQuote(): ?\Tzkt\Model\OriginationOperationAllOfQuote
    {
     ...
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\OriginationOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
