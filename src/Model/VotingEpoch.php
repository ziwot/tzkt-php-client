...
class VotingEpoch implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VotingEpoch';
    ...
    protected static array $openAPITypes = [
        ...
        'end_time' => '\DateTime',
        'status' => 'string',
        'periods' => '\Tzkt\Model\VotingPeriod[]',
        'proposals' => '\Tzkt\Model\Proposal[]'
    ];
    ...
    */
     ...
     * Gets periods
     *
     * @return \Tzkt\Model\VotingPeriod[]|null
     */
     ...
     * Sets periods
     *
     * @param \Tzkt\Model\VotingPeriod[]|null $periods Voting periods in the epoch
     *
     * @return $this
     */
     ...
     * Gets proposals
     *
     * @return \Tzkt\Model\Proposal[]|null
     */
     ...
     * Sets proposals
     *
     * @param \Tzkt\Model\Proposal[]|null $proposals Proposals pushed during the voting epoch (null, if there were no proposals).
     *
     * @return $this
     */
