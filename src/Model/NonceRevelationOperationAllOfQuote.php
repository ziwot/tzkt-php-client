<?php
/**
 * NonceRevelationOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * NonceRevelationOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class NonceRevelationOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'NonceRevelationOperation_allOf_quote';
