...
/**
 * AttestationOperation Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AttestationOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AttestationOperation';
    ...
    */
     ...
     * Gets delegate
     *
     * @return \Tzkt\Model\AttestationOperationAllOfDelegate|null
     */
    public function getDelegate(): ?\Tzkt\Model\AttestationOperationAllOfDelegate
    {
     ...
     * Sets delegate
     *
     * @param \Tzkt\Model\AttestationOperationAllOfDelegate|null $delegate delegate
     *
     * @return $this
     */
    public function setDelegate(?\Tzkt\Model\AttestationOperationAllOfDelegate $delegate): static
    {
        if (is_null($delegate)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\AttestationOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\AttestationOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\AttestationOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\AttestationOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
