<?php
/**
 * PreattestationOperationAllOfDelegate
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * PreattestationOperationAllOfDelegate Class Doc Comment
 *
 ...
 */
class PreattestationOperationAllOfDelegate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PreattestationOperation_allOf_delegate';
