 ...
 */
class MigrationOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MigrationOperation';
    ...
    */
     ...
     */
    public function getAccount(): ?\Tzkt\Model\MigrationOperationAllOfAccount
    {
     ...
     * @return $this
     */
    public function setAccount(?\Tzkt\Model\MigrationOperationAllOfAccount $account): static
    {
        if (is_null($account)) {
     ...
     * @return $this
     */
    public function setBalanceChange(?int $balance_change): static
    {
     ...
     */
    public function getQuote(): ?\Tzkt\Model\MigrationOperationAllOfQuote
    {
     ...
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\MigrationOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
