<?php
/**
 * OperationsGetUpdateSecondaryKeyOpsKeyTypeParameter
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * OperationsGetUpdateSecondaryKeyOpsKeyTypeParameter Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class OperationsGetUpdateSecondaryKeyOpsKeyTypeParameter implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Operations_GetUpdateSecondaryKeyOps_keyType_parameter';
    ...
    */
     ...
     * Sets eq
     *
     * @param string|null $eq **Equal** filter mode (optional, i.e. `param.eq=123` is the same as `param=123`). \\ Specify a secondary key type to get items where the specified field is equal to the specified value.  Example: `?kind=consensus`.
     *
     * @return $this
     */
     ...
     * Sets ne
     *
     * @param string|null $ne **Not equal** filter mode. \\ Specify a secondary key type to get items where the specified field is not equal to the specified value.  Example: `?kind.ne=companion`.
     *
     * @return $this
     */
