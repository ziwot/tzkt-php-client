...
class PreendorsementOperation extends Operation
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PreendorsementOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'delegate' => '\Tzkt\Model\PreendorsementOperationAllOfDelegate',
        'slots' => 'int',
        'quote' => '\Tzkt\Model\PreendorsementOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets delegate
     *
     * @return \Tzkt\Model\PreendorsementOperationAllOfDelegate|null
     */
    public function getDelegate(): ?\Tzkt\Model\PreendorsementOperationAllOfDelegate
    {
     ...
     * Sets delegate
     *
     * @param \Tzkt\Model\PreendorsementOperationAllOfDelegate|null $delegate delegate
     *
     * @return $this
     */
    public function setDelegate(?\Tzkt\Model\PreendorsementOperationAllOfDelegate $delegate): static
    {
        if (is_null($delegate)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\PreendorsementOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\PreendorsementOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\PreendorsementOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\PreendorsementOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
