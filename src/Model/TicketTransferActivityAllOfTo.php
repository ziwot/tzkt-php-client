...
/**
 * TicketTransferActivityAllOfTo Class Doc Comment
 *
 * @description Recipient account.   Click on the field to expand more details.
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class TicketTransferActivityAllOfTo implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TicketTransferActivity_allOf_to';
