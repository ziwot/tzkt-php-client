...
class StakingUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StakingUpdate';
    ...
    protected static array $attributeMap = [
        ...
        'double_consensus_op_id' => 'doubleConsensusOpId',
    ...
    protected static array $setters = [
        ...
        'double_consensus_op_id' => 'setDoubleConsensusOpId',
    ...
    protected static array $getters = [
        ...
        'double_consensus_op_id' => 'getDoubleConsensusOpId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('double_consensus_op_id', $data ?? [], null);
    ...
    */
     ...
     * Sets cycle
     *
     * @param int|null $cycle For `unstake`, `restake`, `finalize` and `slash_unstaked` update types it's freezer cycle, otherwise it's cycle of the block.
     *
     * @return $this
     */
    ...
    {
        if (is_null($staker)) {
            throw new InvalidArgumentException('non-nullable staker cannot be null');
        }
     ...
     * @return string|null
     */
    public function getPseudotokens(): ?string
    {
     ...
     * @return $this
     */
    public function setPseudotokens(?string $pseudotokens): static
    {
     ...
     * @return int|null
     */
    public function getAutostakingOpId(): ?int
    {
     ...
     * @return $this
     */
    public function setAutostakingOpId(?int $autostaking_op_id): static
    {
     ...
     * @return int|null
     */
    public function getStakingOpId(): ?int
    {
     ...
     * @return $this
     */
    public function setStakingOpId(?int $staking_op_id): static
    {
     ...
     * @return int|null
     */
    public function getDelegationOpId(): ?int
    {
     ...
     * @return $this
     */
    public function setDelegationOpId(?int $delegation_op_id): static
    {
     ...
     * @return int|null
     */
    public function getDoubleBakingOpId(): ?int
    {
     ...
     * @return $this
     */
    public function setDoubleBakingOpId(?int $double_baking_op_id): static
    {
    ...
    /**
     * Gets double_consensus_op_id
     *
     * @return int|null
     */
    public function getDoubleConsensusOpId(): ?int
    {
        return $this->container['double_consensus_op_id'];
    }

    /**
     * Sets double_consensus_op_id
     *
     * @param int|null $double_consensus_op_id Id of the operation, caused the staking update. If all `..OpId` fields are null, then the staking update was produced by the protocol migration.
     *
     * @return $this
     */
    public function setDoubleConsensusOpId(?int $double_consensus_op_id): static
    {
        if (is_null($double_consensus_op_id)) {
            array_push($this->openAPINullablesSetToNull, 'double_consensus_op_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('double_consensus_op_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['double_consensus_op_id'] = $double_consensus_op_id;
     ...
     * @return int|null
     */
    public function getDoubleEndorsingOpId(): ?int
    {
     ...
     *
     * @param int|null $double_endorsing_op_id **DEPRECATED**
     *
     * @return $this
     */
    public function setDoubleEndorsingOpId(?int $double_endorsing_op_id): static
    {
     ...
     * @return int|null
     */
    public function getDoublePreendorsingOpId(): ?int
    {
     ...
     *
     * @param int|null $double_preendorsing_op_id **DEPRECATED**
     *
     * @return $this
     */
    public function setDoublePreendorsingOpId(?int $double_preendorsing_op_id): static
    {
