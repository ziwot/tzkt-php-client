<?php
/**
 * DrainDelegateOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * DrainDelegateOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class DrainDelegateOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DrainDelegateOperation_allOf_quote';
