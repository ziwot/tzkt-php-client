<?php
/**
 * DalAttestationRewardOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * DalAttestationRewardOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class DalAttestationRewardOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DalAttestationRewardOperation_allOf_quote';
