...
class VotingPeriod implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VotingPeriod';
    ...
    */
     ...
     * @return float|null
     */
    public function getUpvotesQuorum(): ?float
    {
     ...
     * @return $this
     */
    public function setUpvotesQuorum(?float $upvotes_quorum): static
    {
     ...
     * @return $this
     */
    public function setProposalsCount(?int $proposals_count): static
    {
     ...
     * @return int|null
     */
    public function getTopUpvotes(): ?int
    {
     ...
     * @return $this
     */
    public function setTopUpvotes(?int $top_upvotes): static
    {
     ...
     * @return int|null
     */
    public function getTopVotingPower(): ?int
    {
     ...
     * @return $this
     */
    public function setTopVotingPower(?int $top_voting_power): static
    {
     ...
     * @return float|null
     */
    public function getBallotsQuorum(): ?float
    {
     ...
     * @return $this
     */
    public function setBallotsQuorum(?float $ballots_quorum): static
    {
     ...
     * @return float|null
     */
    public function getSupermajority(): ?float
    {
     ...
     * @return $this
     */
    public function setSupermajority(?float $supermajority): static
    {
     ...
     * @return int|null
     */
    public function getYayBallots(): ?int
    {
     ...
     * @return $this
     */
    public function setYayBallots(?int $yay_ballots): static
    {
     ...
     * @return int|null
     */
    public function getYayVotingPower(): ?int
    {
     ...
     * @return $this
     */
    public function setYayVotingPower(?int $yay_voting_power): static
    {
     ...
     * @return int|null
     */
    public function getNayBallots(): ?int
    {
     ...
     * @return $this
     */
    public function setNayBallots(?int $nay_ballots): static
    {
     ...
     * @return int|null
     */
    public function getNayVotingPower(): ?int
    {
     ...
     * @return $this
     */
    public function setNayVotingPower(?int $nay_voting_power): static
    {
     ...
     * @return int|null
     */
    public function getPassBallots(): ?int
    {
     ...
     * @return $this
     */
    public function setPassBallots(?int $pass_ballots): static
    {
     ...
     * @return int|null
     */
    public function getPassVotingPower(): ?int
    {
     ...
     * @return $this
     */
    public function setPassVotingPower(?int $pass_voting_power): static
    {
