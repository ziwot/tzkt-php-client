...
class BakingRight implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the right: - `baking` - right to bake (produce) a block; - `attestation` - right to attest (validate) a block.
     *
     * @return $this
     */
     ...
     * Sets level
     *
     * @param int|null $level Level at which a block must be baked or an attestation must be sent.
     *
     * @return $this
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime|null $timestamp Time (estimated, in case of future rights) when a block must be baked or an attestation must be sent.
     *
     * @return $this
     */
     ...
     * Sets round
     *
     * @param int|null $round Round (0 - ∞) at which the baker can propose/produce a block. If a baker at round  `0` doesn't produce a block within the given time interval, then the right goes to a baker at round` 1`, etc. For `attestation` rights this field is always `null`.
     *
     * @return $this
     */
     ...
     * Sets slots
     *
     * @param int|null $slots Number of slots to be attested. For `baking` rights this field is always `null`.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the baking or attestation right: - `future` - the right is not realized yet; - `realized` - the right was successfully realized; - `missed` - the right was not realized.
     *
     * @return $this
     */
