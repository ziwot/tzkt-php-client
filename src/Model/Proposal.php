...
class Proposal implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Proposal';
    ...
    protected static array $openAPITypes = [
        'hash' => 'string',
        'initiator' => '\Tzkt\Model\ProposalInitiator',
        'first_period' => 'int',
        'last_period' => 'int',
        'epoch' => 'int',
        'upvotes' => 'int',
    ...
    */
     ...
     * Gets initiator
     *
     * @return \Tzkt\Model\ProposalInitiator|null
     */
    public function getInitiator(): ?\Tzkt\Model\ProposalInitiator
    {
     ...
     * Sets initiator
     *
     * @param \Tzkt\Model\ProposalInitiator|null $initiator initiator
     *
     * @return $this
     */
    public function setInitiator(?\Tzkt\Model\ProposalInitiator $initiator): static
    {
     ...
     * @return $this
     */
    public function setFirstPeriod(?int $first_period): static
    {
     ...
     * @return $this
     */
    public function setLastPeriod(?int $last_period): static
    {
