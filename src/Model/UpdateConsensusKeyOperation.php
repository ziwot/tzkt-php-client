...
class UpdateConsensusKeyOperation extends Operation
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateConsensusKeyOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\UpdateConsensusKeyOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'quote' => '\Tzkt\Model\UpdateConsensusKeyOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\UpdateConsensusKeyOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\UpdateConsensusKeyOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\UpdateConsensusKeyOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\UpdateConsensusKeyOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\UpdateConsensusKeyOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\UpdateConsensusKeyOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\UpdateConsensusKeyOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\UpdateConsensusKeyOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
