...
/**
 * AttestationRewardOperation Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AttestationRewardOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AttestationRewardOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'timestamp' => '\DateTime',
        'block' => 'string',
        'baker' => '\Tzkt\Model\AttestationRewardOperationAllOfBaker',
        'expected' => 'int',
        'reward_delegated' => 'int',
        'reward_staked_own' => 'int',
        'reward_staked_edge' => 'int',
        'reward_staked_shared' => 'int',
        'quote' => '\Tzkt\Model\AttestationRewardOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `attestation_reward`
     *
     * @return $this
     */
     ...
     * Gets baker
     *
     * @return \Tzkt\Model\AttestationRewardOperationAllOfBaker|null
     */
    public function getBaker(): ?\Tzkt\Model\AttestationRewardOperationAllOfBaker
    {
     ...
     * Sets baker
     *
     * @param \Tzkt\Model\AttestationRewardOperationAllOfBaker|null $baker baker
     *
     * @return $this
     */
    public function setBaker(?\Tzkt\Model\AttestationRewardOperationAllOfBaker $baker): static
    {
        if (is_null($baker)) {
     ...
     * Sets expected
     *
     * @param int|null $expected Expected attestation reward, based on baker's active stake (micro tez)
     *
     * @return $this
     */
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\AttestationRewardOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\AttestationRewardOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\AttestationRewardOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\AttestationRewardOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
