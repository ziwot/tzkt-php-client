 ...
 */
class RegisterConstantOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RegisterConstantOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\RegisterConstantOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'quote' => '\Tzkt\Model\RegisterConstantOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\RegisterConstantOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\RegisterConstantOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\RegisterConstantOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\RegisterConstantOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\RegisterConstantOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\RegisterConstantOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\RegisterConstantOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\RegisterConstantOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
