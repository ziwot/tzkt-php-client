...
/**
 * PreattestationOperation Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PreattestationOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PreattestationOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'delegate' => '\Tzkt\Model\PreattestationOperationAllOfDelegate',
        'slots' => 'int',
        'quote' => '\Tzkt\Model\PreattestationOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `preattestation`
     *
     * @return $this
     */
     ...
     * Gets delegate
     *
     * @return \Tzkt\Model\PreattestationOperationAllOfDelegate|null
     */
    public function getDelegate(): ?\Tzkt\Model\PreattestationOperationAllOfDelegate
    {
     ...
     * Sets delegate
     *
     * @param \Tzkt\Model\PreattestationOperationAllOfDelegate|null $delegate delegate
     *
     * @return $this
     */
    public function setDelegate(?\Tzkt\Model\PreattestationOperationAllOfDelegate $delegate): static
    {
        if (is_null($delegate)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\PreattestationOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\PreattestationOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\PreattestationOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\PreattestationOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
