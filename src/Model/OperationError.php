...
class OperationError implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public const TYPE_CONTRACT_BALANCE_TOO_LOW = 'contract.balance_too_low';
    public const TYPE_CONTRACT_MANAGER_UNREGISTERED_DELEGATE = 'contract.manager.unregistered_delegate';
    public const TYPE_CONTRACT_NON_EXISTING_CONTRACT = 'contract.non_existing_contract';
    public const TYPE_ERROR_ID = 'error.id';
