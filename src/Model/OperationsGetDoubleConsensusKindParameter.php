<?php
/**
 * OperationsGetDoubleConsensusKindParameter
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * OperationsGetDoubleConsensusKindParameter Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class OperationsGetDoubleConsensusKindParameter implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Operations_GetDoubleConsensus_kind_parameter';
    ...
    */
     ...
     * Sets eq
     *
     * @param string|null $eq **Equal** filter mode (optional, i.e. `param.eq=123` is the same as `param=123`). \\ Specify a double consensus kind to get items where the specified field is equal to the specified value.  Example: `?type=double_attestation`.
     *
     * @return $this
     */
     ...
     * Sets ne
     *
     * @param string|null $ne **Not equal** filter mode. \\ Specify a double consensus kind to get items where the specified field is not equal to the specified value.  Example: `?type.ne=double_preattestation`.
     *
     * @return $this
     */
