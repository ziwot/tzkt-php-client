...
class Token implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'id' => 'int',
        'contract' => '\Tzkt\Model\TokenInfoContract',
        'token_id' => 'string',
        'standard' => 'string',
    ...
    */
     ...
     * Gets contract
     *
     * @return \Tzkt\Model\TokenInfoContract|null
     */
    public function getContract(): ?\Tzkt\Model\TokenInfoContract
    {
     ...
     * Sets contract
     *
     * @param \Tzkt\Model\TokenInfoContract|null $contract contract
     *
     * @return $this
     */
    public function setContract(?\Tzkt\Model\TokenInfoContract $contract): static
    {
        if (is_null($contract)) {
     ...
     * @return $this
     */
    public function setTokenId(?string $token_id): static
    {
        if (is_null($token_id)) {
     ...
     */
    public function getFirstMinter(): ?\Tzkt\Model\TokenFirstMinter
    {
     ...
     * @return $this
     */
    public function setFirstMinter(?\Tzkt\Model\TokenFirstMinter $first_minter): static
    {
