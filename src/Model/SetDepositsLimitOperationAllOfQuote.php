<?php
/**
 * SetDepositsLimitOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * SetDepositsLimitOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class SetDepositsLimitOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SetDepositsLimitOperation_allOf_quote';
