...
class TicketBalance implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TicketBalance';
    ...
    protected static array $openAPITypes = [
        ...
        'account' => '\Tzkt\Model\TicketBalanceAccount',
        'balance' => 'string',
        'transfers_count' => 'int',
        'first_level' => 'int',
        'first_time' => '\DateTime',
    ...
    */
     ...
     * Gets account
     *
     * @return \Tzkt\Model\TicketBalanceAccount|null
     */
    public function getAccount(): ?\Tzkt\Model\TicketBalanceAccount
    {
     ...
     * Sets account
     *
     * @param \Tzkt\Model\TicketBalanceAccount|null $account account
     *
     * @return $this
     */
    public function setAccount(?\Tzkt\Model\TicketBalanceAccount $account): static
    {
        if (is_null($account)) {
