<?php
/**
 * TxRollupFinalizeCommitmentOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * TxRollupFinalizeCommitmentOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class TxRollupFinalizeCommitmentOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TxRollupFinalizeCommitmentOperation_allOf_quote';
    ...
    */
     ...
     * @return $this
     */
    public function setBtc(?float $btc): static
    {
        if (is_null($btc)) {
     ...
     * @return $this
     */
    public function setEth(?float $eth): static
    {
        if (is_null($eth)) {
