...
/**
 * DalAttestationRewardOperation Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DalAttestationRewardOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DalAttestationRewardOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'timestamp' => '\DateTime',
        'block' => 'string',
        'baker' => '\Tzkt\Model\DalAttestationRewardOperationAllOfBaker',
        'expected' => 'int',
        'reward_delegated' => 'int',
        'reward_staked_own' => 'int',
        'reward_staked_edge' => 'int',
        'reward_staked_shared' => 'int',
        'quote' => '\Tzkt\Model\DalAttestationRewardOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `dal_attestation_reward`
     *
     * @return $this
     */
     ...
     * Gets baker
     *
     * @return \Tzkt\Model\DalAttestationRewardOperationAllOfBaker|null
     */
    public function getBaker(): ?\Tzkt\Model\DalAttestationRewardOperationAllOfBaker
    {
     ...
     * Sets baker
     *
     * @param \Tzkt\Model\DalAttestationRewardOperationAllOfBaker|null $baker baker
     *
     * @return $this
     */
    public function setBaker(?\Tzkt\Model\DalAttestationRewardOperationAllOfBaker $baker): static
    {
        if (is_null($baker)) {
     ...
     * Sets expected
     *
     * @param int|null $expected Expected dal attestation reward, based on baker's active stake (micro tez)
     *
     * @return $this
     */
    public function setExpected(?int $expected): static
    {
        if (is_null($expected)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\DalAttestationRewardOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\DalAttestationRewardOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\DalAttestationRewardOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\DalAttestationRewardOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
