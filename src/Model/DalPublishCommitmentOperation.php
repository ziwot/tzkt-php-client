 ...
 */
class DalPublishCommitmentOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DalPublishCommitmentOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'timestamp' => '\DateTime',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\DalPublishCommitmentOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'quote' => '\Tzkt\Model\DalPublishCommitmentOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\DalPublishCommitmentOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\DalPublishCommitmentOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\DalPublishCommitmentOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\DalPublishCommitmentOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * @return $this
     */
    public function setCommitment(?string $commitment): static
    {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\DalPublishCommitmentOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\DalPublishCommitmentOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\DalPublishCommitmentOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\DalPublishCommitmentOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
