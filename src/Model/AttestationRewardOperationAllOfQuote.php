<?php
/**
 * AttestationRewardOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * AttestationRewardOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class AttestationRewardOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AttestationRewardOperation_allOf_quote';
