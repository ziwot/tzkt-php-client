 ...
 */
class RevealOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RevealOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\RevealOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'quote' => '\Tzkt\Model\RevealOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\RevealOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\RevealOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\RevealOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\RevealOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Sets public_key
     *
     * @param string|null $public_key Revealed public key
     *
     * @return $this
     */
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\RevealOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\RevealOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\RevealOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\RevealOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
