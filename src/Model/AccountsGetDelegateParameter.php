...
class AccountsGetDelegateParameter implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Accounts_Get_delegate_parameter';
    ...
    */
     ...
     * @return $this
     */
    public function setEqx(?string $eqx): static
    {
        if (is_null($eqx)) {
     ...
     * @return $this
     */
    public function setNex(?string $nex): static
    {
        if (is_null($nex)) {
     ...
     * @return bool|null
     */
    public function getInHasNull(): ?bool
    {
     ...
     * @return $this
     */
    public function setInHasNull(?bool $in_has_null): static
    {
     ...
     * @return bool|null
     */
    public function getNiHasNull(): ?bool
    {
     ...
     * @return $this
     */
    public function setNiHasNull(?bool $ni_has_null): static
    {
