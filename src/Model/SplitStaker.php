 ...
 */
class SplitStaker implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SplitStaker';
    ...
    */
     ...
     * Sets address
     *
     * @param string|null $address Address of the staker
     *
     * @return $this
     */
