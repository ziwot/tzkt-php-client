...
class SrCommitment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SrCommitment';
    ...
    */
     ...
     */
    public function getRollup(): ?\Tzkt\Model\SrCommitmentRollup
    {
     ...
     * @return $this
     */
    public function setRollup(?\Tzkt\Model\SrCommitmentRollup $rollup): static
    {
        if (is_null($rollup)) {
     ...
     */
    public function getInitiator(): ?\Tzkt\Model\SrCommitmentInfoInitiator
    {
     ...
     * @return $this
     */
    public function setInitiator(?\Tzkt\Model\SrCommitmentInfoInitiator $initiator): static
    {
     ...
     * @return int|null
     */
    public function getStakers(): ?int
    {
     ...
     * @return $this
     */
    public function setStakers(?int $stakers): static
    {
        if (is_null($stakers)) {
     ...
     * @return int|null
     */
    public function getSuccessors(): ?int
    {
     ...
     * @return $this
     */
    public function setSuccessors(?int $successors): static
    {
     ...
     */
    public function getPredecessor(): ?\Tzkt\Model\SrCommitmentPredecessor
    {
     ...
     * @return $this
     */
    public function setPredecessor(?\Tzkt\Model\SrCommitmentPredecessor $predecessor): static
    {
