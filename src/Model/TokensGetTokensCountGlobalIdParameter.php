<?php
/**
 * TokensGetTokensCountGlobalIdParameter
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * TokensGetTokensCountGlobalIdParameter Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TokensGetTokensCountGlobalIdParameter implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Tokens_GetTokensCount_globalId_parameter';
    ...
    */
     ...
     * Sets in
     *
     * @param string|null $in **Not equal** filter mode. \\ Specify token standard (`fa1.2` or `fa2`) to get items where the specified field is not equal to the specified value.  Example: `?type.ne=fa1.2`.
     *
     * @return $this
     */
