 ...
 */
class AutostakingOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AutostakingOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'level' => 'int',
        'timestamp' => '\DateTime',
        'baker' => '\Tzkt\Model\AutostakingOperationAllOfBaker',
        'action' => 'string',
        'amount' => 'int',
        'staking_updates_count' => 'int',
        'quote' => '\Tzkt\Model\AutostakingOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Gets baker
     *
     * @return \Tzkt\Model\AutostakingOperationAllOfBaker|null
     */
    public function getBaker(): ?\Tzkt\Model\AutostakingOperationAllOfBaker
    {
     ...
     * Sets baker
     *
     * @param \Tzkt\Model\AutostakingOperationAllOfBaker|null $baker baker
     *
     * @return $this
     */
    public function setBaker(?\Tzkt\Model\AutostakingOperationAllOfBaker $baker): static
    {
        if (is_null($baker)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\AutostakingOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\AutostakingOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\AutostakingOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\AutostakingOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
