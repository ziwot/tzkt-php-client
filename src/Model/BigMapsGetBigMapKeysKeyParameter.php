<?php
/**
 * BigMapsGetBigMapKeysKeyParameter
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * BigMapsGetBigMapKeysKeyParameter Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BigMapsGetBigMapKeysKeyParameter implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BigMaps_GetBigMapKeys_key_parameter';
    ...
    */
     ...
     * @return $this
     */
    public function setGt(?string $gt): static
    {
        if (is_null($gt)) {
     ...
     * @return $this
     */
    public function setGe(?string $ge): static
    {
        if (is_null($ge)) {
     ...
     * @return $this
     */
    public function setLe(?string $le): static
    {
        if (is_null($le)) {
     ...
     * @return $this
     */
    public function setUn(?string $un): static
    {
        if (is_null($un)) {
