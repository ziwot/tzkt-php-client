...
class State implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * @return $this
     */
    public function setNextProtocol(?string $next_protocol): static
    {
        if (is_null($next_protocol)) {
            throw new InvalidArgumentException('non-nullable next_protocol cannot be null');
        }
     ...
     * @return int|null
     */
    public function getVotingEpoch(): ?int
    {
     ...
     * @return $this
     */
    public function setVotingEpoch(?int $voting_epoch): static
    {
     ...
     * @return $this
     */
    public function setVotingPeriod(?int $voting_period): static
    {
     ...
     * @return $this
     */
    public function setKnownLevel(?int $known_level): static
    {
     ...
     * @return $this
     */
    public function setLastSync(?\DateTime $last_sync): static
    {
     ...
     * @return int|null
     */
    public function getQuoteLevel(): ?int
    {
     ...
     * @return $this
     */
    public function setQuoteLevel(?int $quote_level): static
    {
     ...
     * @return float|null
     */
    public function getQuoteBtc(): ?float
    {
     ...
     * @return $this
     */
    public function setQuoteBtc(?float $quote_btc): static
    {
     ...
     * @return float|null
     */
    public function getQuoteEur(): ?float
    {
     ...
     * @return $this
     */
    public function setQuoteEur(?float $quote_eur): static
    {
     ...
     * @return float|null
     */
    public function getQuoteUsd(): ?float
    {
     ...
     * @return $this
     */
    public function setQuoteUsd(?float $quote_usd): static
    {
     ...
     * @return float|null
     */
    public function getQuoteCny(): ?float
    {
     ...
     * @return $this
     */
    public function setQuoteCny(?float $quote_cny): static
    {
     ...
     * @return float|null
     */
    public function getQuoteJpy(): ?float
    {
     ...
     * @return $this
     */
    public function setQuoteJpy(?float $quote_jpy): static
    {
     ...
     * @return float|null
     */
    public function getQuoteKrw(): ?float
    {
     ...
     * @return $this
     */
    public function setQuoteKrw(?float $quote_krw): static
    {
     ...
     * @return float|null
     */
    public function getQuoteEth(): ?float
    {
     ...
     * @return $this
     */
    public function setQuoteEth(?float $quote_eth): static
    {
     ...
     * @return float|null
     */
    public function getQuoteGbp(): ?float
    {
     ...
     * @return $this
     */
    public function setQuoteGbp(?float $quote_gbp): static
    {
