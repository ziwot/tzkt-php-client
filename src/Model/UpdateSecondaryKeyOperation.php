...
/**
 * UpdateSecondaryKeyOperation Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateSecondaryKeyOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateSecondaryKeyOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'block' => 'string',
        'hash' => 'string',
        'sender' => '\Tzkt\Model\UpdateSecondaryKeyOperationAllOfSender',
        'counter' => 'int',
        'gas_limit' => 'int',
        'gas_used' => 'int',
        'storage_limit' => 'int',
        ...
        'quote' => '\Tzkt\Model\UpdateSecondaryKeyOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `update_secondary_key`
     *
     * @return $this
     */
     ...
     * Gets sender
     *
     * @return \Tzkt\Model\UpdateSecondaryKeyOperationAllOfSender|null
     */
    public function getSender(): ?\Tzkt\Model\UpdateSecondaryKeyOperationAllOfSender
    {
     ...
     * Sets sender
     *
     * @param \Tzkt\Model\UpdateSecondaryKeyOperationAllOfSender|null $sender sender
     *
     * @return $this
     */
    public function setSender(?\Tzkt\Model\UpdateSecondaryKeyOperationAllOfSender $sender): static
    {
        if (is_null($sender)) {
     ...
     * Sets key_type
     *
     * @param string|null $key_type Type of the key: `consensus` or `companion`
     *
     * @return $this
     */
    public function setKeyType(?string $key_type): static
    {
        if (is_null($key_type)) {
     ...
     *
     * @param int|null $activation_cycle Index of the cycle from which the secondary key will be active
     *
     * @return $this
     */
     ...
     * Sets public_key
     *
     * @param string|null $public_key Secondary key
     *
     * @return $this
     */
     ...
     *
     * @param string|null $public_key_hash Secondary key hash
     *
     * @return $this
     */
    public function setPublicKeyHash(?string $public_key_hash): static
    {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\UpdateSecondaryKeyOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\UpdateSecondaryKeyOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\UpdateSecondaryKeyOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\UpdateSecondaryKeyOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
