 ...
 */
class SmartRollup implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'creator' => false,
        'pvm_kind' => false,
        'genesis_commitment' => false,
        'last_commitment' => false,
        'inbox_level' => false,
        'total_stakers' => false,
    ...
    */
    ...
    {
        if (is_null($pvm_kind)) {
            throw new InvalidArgumentException('non-nullable pvm_kind cannot be null');
        }
    ...
    public function setGenesisCommitment(?string $genesis_commitment): static
    {
        if (is_null($genesis_commitment)) {
            throw new InvalidArgumentException('non-nullable genesis_commitment cannot be null');
        }
    ...
    public function setLastCommitment(?string $last_commitment): static
    {
        if (is_null($last_commitment)) {
            throw new InvalidArgumentException('non-nullable last_commitment cannot be null');
        }
