...
class StakingGetStakingUpdatesCountRoundingErrorParameter implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Staking_GetStakingUpdatesCount_roundingError_parameter';
    ...
    */
     ...
     * @return $this
     */
    public function setNe(?int $ne): static
    {
        if (is_null($ne)) {
     ...
     * @return $this
     */
    public function setGe(?int $ge): static
    {
        if (is_null($ge)) {
     ...
     * @return $this
     */
    public function setLe(?int $le): static
    {
        if (is_null($le)) {
