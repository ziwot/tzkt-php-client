...
class Domain implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'level' => 'int',
        'name' => 'string',
        'owner' => '\Tzkt\Model\DomainOwner',
        'address' => '\Tzkt\Model\DomainAddress',
        'reverse' => 'bool',
        'expiration' => '\DateTime',
        'data' => 'mixed',
        'first_level' => 'int',
    ...
    */
     ...
     * Gets owner
     *
     * @return \Tzkt\Model\DomainOwner|null
     */
    public function getOwner(): ?\Tzkt\Model\DomainOwner
    {
     ...
     * Sets owner
     *
     * @param \Tzkt\Model\DomainOwner|null $owner owner
     *
     * @return $this
     */
    public function setOwner(?\Tzkt\Model\DomainOwner $owner): static
    {
        if (is_null($owner)) {
     ...
     * Gets address
     *
     * @return \Tzkt\Model\DomainAddress|null
     */
    public function getAddress(): ?\Tzkt\Model\DomainAddress
    {
     ...
     * Sets address
     *
     * @param \Tzkt\Model\DomainAddress|null $address address
     *
     * @return $this
     */
    public function setAddress(?\Tzkt\Model\DomainAddress $address): static
    {
        if (is_null($address)) {
