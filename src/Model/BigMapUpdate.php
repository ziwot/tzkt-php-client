...
class BigMapUpdate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BigMapUpdate';
    ...
    protected static array $openAPITypes = [
        ...
        'path' => 'string',
        'action' => 'string',
        'content' => '\Tzkt\Model\BigMapUpdateContent'
    ];
    ...
    */
     ...
     * @return $this
     */
    public function setBigmap(?int $bigmap): static
    {
        if (is_null($bigmap)) {
     ...
     * Gets content
     *
     * @return \Tzkt\Model\BigMapUpdateContent|null
     */
    public function getContent(): ?\Tzkt\Model\BigMapUpdateContent
    {
     ...
     * Sets content
     *
     * @param \Tzkt\Model\BigMapUpdateContent|null $content content
     *
     * @return $this
     */
    public function setContent(?\Tzkt\Model\BigMapUpdateContent $content): static
    {
        if (is_null($content)) {
