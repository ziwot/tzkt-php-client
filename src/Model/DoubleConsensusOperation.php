...
/**
 * DoubleConsensusOperation Class Doc Comment
 *
 * @package  Tzkt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DoubleConsensusOperation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DoubleConsensusOperation';
    ...
    protected static array $openAPITypes = [
        ...
        'slashed_level' => 'int',
        'kind' => 'string',
        'accuser' => '\Tzkt\Model\DoubleConsensusOperationAllOfAccuser',
        'reward' => 'int',
        'offender' => '\Tzkt\Model\DoubleConsensusOperationAllOfOffender',
        'lost_staked' => 'int',
        'lost_unstaked' => 'int',
        'lost_external_staked' => 'int',
        'lost_external_unstaked' => 'int',
        'staking_updates_count' => 'int',
        'quote' => '\Tzkt\Model\DoubleConsensusOperationAllOfQuote'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `double_consensus` - is used by bakers to provide evidence of double (pre)attestation ((pre)attestation of two different blocks at the same block height) by a baker
     *
     * @return $this
     */
     ...
     * Sets accused_level
     *
     * @param int|null $accused_level Height of the block from the genesis, at which double (pre)attestation occurred
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string|null $kind Kind of misbehaviour (`double_attestation` or `double_preattestation`)
     *
     * @return $this
     */
     ...
     * Gets accuser
     *
     * @return \Tzkt\Model\DoubleConsensusOperationAllOfAccuser|null
     */
    public function getAccuser(): ?\Tzkt\Model\DoubleConsensusOperationAllOfAccuser
    {
     ...
     * Sets accuser
     *
     * @param \Tzkt\Model\DoubleConsensusOperationAllOfAccuser|null $accuser accuser
     *
     * @return $this
     */
    public function setAccuser(?\Tzkt\Model\DoubleConsensusOperationAllOfAccuser $accuser): static
    {
        if (is_null($accuser)) {
     ...
     * Gets offender
     *
     * @return \Tzkt\Model\DoubleConsensusOperationAllOfOffender|null
     */
    public function getOffender(): ?\Tzkt\Model\DoubleConsensusOperationAllOfOffender
    {
     ...
     * Sets offender
     *
     * @param \Tzkt\Model\DoubleConsensusOperationAllOfOffender|null $offender offender
     *
     * @return $this
     */
    public function setOffender(?\Tzkt\Model\DoubleConsensusOperationAllOfOffender $offender): static
    {
        if (is_null($offender)) {
     ...
     * Gets quote
     *
     * @return \Tzkt\Model\DoubleConsensusOperationAllOfQuote|null
     */
    public function getQuote(): ?\Tzkt\Model\DoubleConsensusOperationAllOfQuote
    {
     ...
     * Sets quote
     *
     * @param \Tzkt\Model\DoubleConsensusOperationAllOfQuote|null $quote quote
     *
     * @return $this
     */
    public function setQuote(?\Tzkt\Model\DoubleConsensusOperationAllOfQuote $quote): static
    {
        if (is_null($quote)) {
