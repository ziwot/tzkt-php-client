...
class Ticket implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'id' => 'int',
        'ticketer' => '\Tzkt\Model\TicketTicketer',
        'raw_type' => '\Tzkt\Model\TicketRawType',
        'raw_content' => '\Tzkt\Model\TicketRawContent',
        'content' => 'mixed',
        'type_hash' => 'int',
        'content_hash' => 'int',
    ...
    */
     ...
     * Gets ticketer
     *
     * @return \Tzkt\Model\TicketTicketer|null
     */
    public function getTicketer(): ?\Tzkt\Model\TicketTicketer
    {
     ...
     * Sets ticketer
     *
     * @param \Tzkt\Model\TicketTicketer|null $ticketer ticketer
     *
     * @return $this
     */
    public function setTicketer(?\Tzkt\Model\TicketTicketer $ticketer): static
    {
        if (is_null($ticketer)) {
     ...
     * Gets raw_type
     *
     * @return \Tzkt\Model\TicketRawType|null
     */
    public function getRawType(): ?\Tzkt\Model\TicketRawType
    {
     ...
     * Sets raw_type
     *
     * @param \Tzkt\Model\TicketRawType|null $raw_type raw_type
     *
     * @return $this
     */
    public function setRawType(?\Tzkt\Model\TicketRawType $raw_type): static
    {
        if (is_null($raw_type)) {
     ...
     * Gets raw_content
     *
     * @return \Tzkt\Model\TicketRawContent|null
     */
    public function getRawContent(): ?\Tzkt\Model\TicketRawContent
    {
     ...
     * Sets raw_content
     *
     * @param \Tzkt\Model\TicketRawContent|null $raw_content raw_content
     *
     * @return $this
     */
    public function setRawContent(?\Tzkt\Model\TicketRawContent $raw_content): static
    {
