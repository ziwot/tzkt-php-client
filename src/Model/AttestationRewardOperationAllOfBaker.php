<?php
/**
 * AttestationRewardOperationAllOfBaker
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * AttestationRewardOperationAllOfBaker Class Doc Comment
 *
 ...
 */
class AttestationRewardOperationAllOfBaker implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AttestationRewardOperation_allOf_baker';
