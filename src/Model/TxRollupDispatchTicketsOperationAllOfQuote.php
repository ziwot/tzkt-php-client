<?php
/**
 * TxRollupDispatchTicketsOperationAllOfQuote
 *
 * PHP version 8.1
 *
 * @package  Tzkt
...
/**
 * TxRollupDispatchTicketsOperationAllOfQuote Class Doc Comment
 *
 ...
 */
class TxRollupDispatchTicketsOperationAllOfQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TxRollupDispatchTicketsOperation_allOf_quote';
